...
function setSettings() {
  ...
  setClan((0,dist.get)("asmocs_mainClan", "Alliance From Heck"));
  (0,dist.set)("choiceAdventure1106", 3); //Halloweiner Dog get Food rather than Buff
...
function prepGear() {
  ...
  if (!(0,dist.have)((0,dist.$item)(runstart_templateObject42 || (runstart_templateObject42 = runstart_taggedTemplateLiteral(["pantogram pants"]))))) {
...
function deck() {
  if (!(0,dist.get)("_deckCardsDrawn")) {
    (0,external_kolmafia_.cliExecute)("cheat wrench; cheat rope"); //autosell(1, $item`1952 Mickey Mantle card`);
...
function buff100() {
  if (!(0,external_kolmafia_.haveEffect)((0,dist.$effect)(runstart_templateObject43 || (runstart_templateObject43 = runstart_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"]))))) {
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=campaway&action=campaway_sky");
  }

  ensureSong((0,dist.$effect)(runstart_templateObject44 || (runstart_templateObject44 = runstart_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))));

  if (!(0,external_kolmafia_.haveEffect)((0,dist.$effect)(runstart_templateObject45 || (runstart_templateObject45 = runstart_taggedTemplateLiteral(["Inscrutable Gaze"]))))) {
    //ensureMpTonic(10);
    ensureEffect((0,dist.$effect)(runstart_templateObject46 || (runstart_templateObject46 = runstart_taggedTemplateLiteral(["Inscrutable Gaze"]))));
  }
...
function firstFights() {
  ...
  (0,external_kolmafia_.equip)((0,dist.$slot)(coil_wire_templateObject6 || (coil_wire_templateObject6 = coil_wire_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(coil_wire_templateObject7 || (coil_wire_templateObject7 = coil_wire_taggedTemplateLiteral(["latte lovers member's mug"])))); //useFamiliar($familiar`Reanimated Reanimator`)
...
function buffMyst() {
  ...
  if (!(0,dist.get)("_favoriteBirdVisited")) (0,external_kolmafia_.useSkill)((0,dist.$skill)(level_templateObject29 || (level_templateObject29 = level_taggedTemplateLiteral(["Visit your Favorite Bird"])))); // eslint-disable-next-line libram/verify-constants
...
function witchGhostAgent() {
  ...
  if (!(0,dist.have)((0,dist.$item)(level_templateObject57 || (level_templateObject57 = level_taggedTemplateLiteral(["government"])))) && !(0,dist.have)((0,dist.$item)(level_templateObject58 || (level_templateObject58 = level_taggedTemplateLiteral(["government cheese"]))))) {
    ...
    phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject67 || (level_templateObject67 = level_taggedTemplateLiteral(["Noob Cave"]))), dist.Macro.step(phccs_macros_delevel).skill("otoscope").skill("become a bat").skill("chest x-ray"), //1
    () => {
...
function lov() {
  ...
  if (!(0,dist.get)("_loveTunnelUsed")) {
    dist.TunnelOfLove.fightAll("LOV Epaulettes", "Open Heart Surgery", "LOV Extraterrestrial Chocolate"); //use(1, $item`LOV Extraterrestrial Chocolate`);
...
function tomatoJuiceAndNinjaCostume() {
  ...
  if (!(0,dist.get)("hasRange")) {
    if (!(0,dist.have)((0,dist.$item)(level_templateObject73 || (level_templateObject73 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))))) {
      (0,external_kolmafia_.buy)(1, (0,dist.$item)(level_templateObject74 || (level_templateObject74 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
    }

    (0,external_kolmafia_.use)(1, (0,dist.$item)(level_templateObject75 || (level_templateObject75 = level_taggedTemplateLiteral(["Dramatic\u2122 range"]))));
  }

  (0,external_kolmafia_.useSkill)((0,dist.$skill)(level_templateObject76 || (level_templateObject76 = level_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(level_templateObject77 || (level_templateObject77 = level_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))));

  if (!(0,dist.have)((0,dist.$effect)(level_templateObject78 || (level_templateObject78 = level_taggedTemplateLiteral(["Tomato Power"]))))) {
    if (!(0,dist.have)((0,dist.$item)(level_templateObject79 || (level_templateObject79 = level_taggedTemplateLiteral(["tomato juice of powerful power"])))) && (0,dist.have)((0,dist.$item)(level_templateObject80 || (level_templateObject80 = level_taggedTemplateLiteral(["tomato"]))))) {
      (0,external_kolmafia_.create)(1, (0,dist.$item)(level_templateObject81 || (level_templateObject81 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }

    if ((0,dist.have)((0,dist.$item)(level_templateObject82 || (level_templateObject82 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))))) {
      (0,external_kolmafia_.use)(1, (0,dist.$item)(level_templateObject83 || (level_templateObject83 = level_taggedTemplateLiteral(["tomato juice of powerful power"]))));
    }
  }

  if (!(0,dist.have)((0,dist.$effect)(level_templateObject84 || (level_templateObject84 = level_taggedTemplateLiteral(["Mystically Oiled"]))))) {
    if (!(0,dist.have)((0,dist.$item)(level_templateObject85 || (level_templateObject85 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_.create)(1, (0,dist.$item)(level_templateObject86 || (level_templateObject86 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }

    if ((0,dist.have)((0,dist.$item)(level_templateObject87 || (level_templateObject87 = level_taggedTemplateLiteral(["ointment of the occult"]))))) {
      (0,external_kolmafia_.use)(1, (0,dist.$item)(level_templateObject88 || (level_templateObject88 = level_taggedTemplateLiteral(["ointment of the occult"]))));
    }
  }
}
...
function godLob() {
  if ((0,dist.get)("_godLobsterFights") === 0) {
    ...
    outfits_uniform();
    (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject89 || (level_templateObject89 = level_taggedTemplateLiteral(["shirt"]))), (0,dist.$item)(level_templateObject90 || (level_templateObject90 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))));
    phredhccs_lib_heal();
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(level_templateObject91 || (level_templateObject91 = level_taggedTemplateLiteral(["God Lobster"]))));
    setChoice(1310, 1);
    ...
    (0,external_kolmafia_.runChoice)(-1);
    (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject92 || (level_templateObject92 = level_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(level_templateObject93 || (level_templateObject93 = level_taggedTemplateLiteral(["God Lobster's Scepter"]))));
    phredhccs_lib_heal();
    (0,external_kolmafia_.visitUrl)("main.php?fightgodlobster=1");
    (0,external_kolmafia_.runCombat)();
    multiFightAutoAttack();
    (0,external_kolmafia_.runChoice)(-1);
    (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject94 || (level_templateObject94 = level_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(level_templateObject95 || (level_templateObject95 = level_taggedTemplateLiteral(["God Lobster's Ring"]))));
  }
}
...
function snojo() {
  ...
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject96 || (level_templateObject96 = level_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), dist.Macro.item((0,dist.$item)(level_templateObject97 || (level_templateObject97 = level_taggedTemplateLiteral(["DNA extraction syringe"])))).step(phccs_macros_delevel).step(phccs_macros_easyFight).attack().repeat(), () => {
    return (0,dist.get)("dnaSyringe") !== "construct";
  }, () => {
    phredhccs_lib_heal();
    phredhccs_lib_useDefaultFamiliar();
    geneTonic("construct");
    ensureEffect((0,dist.$effect)(level_templateObject98 || (level_templateObject98 = level_taggedTemplateLiteral(["Human-Machine Hybrid"]))));
  });
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject99 || (level_templateObject99 = level_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), dist.Macro.step(phccs_macros_delevel).step(phccs_macros_easyFight).attack().repeat(), () => {
...
function NEP() {
  ...
  outfits_uniform();
  (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject100 || (level_templateObject100 = level_taggedTemplateLiteral(["shirt"]))), (0,dist.$item)(level_templateObject101 || (level_templateObject101 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject102 || (level_templateObject102 = level_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(level_templateObject103 || (level_templateObject103 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
  phredhccs_lib_useDefaultFamiliar();
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject104 || (level_templateObject104 = level_taggedTemplateLiteral(["The Neverending Party"]))), dist.Macro.step(phccs_macros_delevel).trySkill("feel pride").trySkill((0,dist.$skill)(level_templateObject105 || (level_templateObject105 = level_taggedTemplateLiteral(["%fn, spit on me!"])))).step(phccs_macros_easyFight).attack().repeat(), () => {
    return (0,dist.get)("_neverendingPartyFreeTurns") < 10;
  }, () => {
    phredhccs_lib_useDefaultFamiliar();
    phredhccs_lib_heal();

    if ((0,dist.get)("_sausageFights") > 3 && (0,external_kolmafia_.haveEquipped)((0,dist.$item)(level_templateObject106 || (level_templateObject106 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject107 || (level_templateObject107 = level_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(level_templateObject108 || (level_templateObject108 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    }
    ...
    if ((0,external_kolmafia_.myLevel)() >= 13 && !(0,dist.have)((0,dist.$effect)(level_templateObject109 || (level_templateObject109 = level_taggedTemplateLiteral(["Inner Elf"]))))) {
      ensureInnerElf();
    }
  });
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject110 || (level_templateObject110 = level_taggedTemplateLiteral(["The Neverending Party"]))), dist.Macro.if_("!monstername sausage goblin", dist.Macro.trySkill("shattering punch").trySkill("gingerbread mob hit").trySkill("chest x-ray")).if_("monstername sausage goblin", dist.Macro.step(phccs_macros_delevel).step(phccs_macros_candyblast).attack().repeat()), () => {
    return (0,dist.get)("_shatteringPunchUsed") < 3 && !(0,dist.get)("_gingerbreadMobHitUsed");
  }, () => {
    phredhccs_lib_heal();
    phredhccs_lib_useDefaultFamiliar();

    if ((0,dist.get)("_sausageFights") > 3 && (0,external_kolmafia_.haveEquipped)((0,dist.$item)(level_templateObject111 || (level_templateObject111 = level_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))))) {
      (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject112 || (level_templateObject112 = level_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(level_templateObject113 || (level_templateObject113 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
    }
    ...
    if ((0,external_kolmafia_.myLevel)() >= 13 && !(0,dist.have)((0,dist.$effect)(level_templateObject114 || (level_templateObject114 = level_taggedTemplateLiteral(["Inner Elf"]))))) {
      ensureInnerElf();
    }
  });
  (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject115 || (level_templateObject115 = level_taggedTemplateLiteral(["acc3"]))), (0,dist.$item)(level_templateObject116 || (level_templateObject116 = level_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject117 || (level_templateObject117 = level_taggedTemplateLiteral(["The Neverending Party"]))), dist.Macro.if_("!monstername sausage goblin", dist.Macro.trySkill("shattering punch").trySkill("gingerbread mob hit").trySkill("chest x-ray")).if_("monstername sausage goblin", dist.Macro.step(phccs_macros_delevel).step(phccs_macros_candyblast).attack().repeat()), () => {
...
function mElfLeveling() {
  ...
  (0,external_kolmafia_.equip)((0,dist.$slot)(level_templateObject122 || (level_templateObject122 = level_taggedTemplateLiteral(["shirt"]))), (0,dist.$item)(level_templateObject123 || (level_templateObject123 = level_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(level_templateObject124 || (level_templateObject124 = level_taggedTemplateLiteral(["Machine Elf"]))));
  phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject125 || (level_templateObject125 = level_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), defaultKill, () => {
    return (0,dist.get)("_machineTunnelsAdv") < 5;
  }, phredhccs_lib_heal);
}

function royalty() {
  if (!(0,dist.have)((0,dist.$item)(level_templateObject126 || (level_templateObject126 = level_taggedTemplateLiteral(["very pointy crown"]))))) {
    dist.Macro.tryItem("jam band flyer").tryItem("gas can").tryItem("time-spinner").attack().repeat().setAutoAttack();
    outfits_uniform();
    phredhccs_lib_useDefaultFamiliar();
    phredhccs_lib_heal();
    dist.Witchess.fightPiece((0,dist.$monster)(level_templateObject127 || (level_templateObject127 = level_taggedTemplateLiteral(["Witchess Queen"]))));
  }

  if (!(0,dist.have)((0,dist.$item)(level_templateObject128 || (level_templateObject128 = level_taggedTemplateLiteral(["dented scepter"]))))) {
    dist.Macro.step(phccs_macros_delevel).attack().repeat().setAutoAttack();
    outfits_uniform();
    phredhccs_lib_useDefaultFamiliar();
    phredhccs_lib_heal();
    dist.Witchess.fightPiece((0,dist.$monster)(level_templateObject129 || (level_templateObject129 = level_taggedTemplateLiteral(["Witchess King"]))));
  }
}

function restAndBuff() {
  dist.ChateauMantegna.changeNightstand((0,dist.$item)(level_templateObject130 || (level_templateObject130 = level_taggedTemplateLiteral(["foreign language tapes"]))));
...
function digitwinked() {
  ...
  if (!get("latteUnlocks").includes("chili")) {
    equip($slot(level_templateObject131 || (level_templateObject131 = level_taggedTemplateLiteral(["off-hand"]))), $item(level_templateObject132 || (level_templateObject132 = level_taggedTemplateLiteral(["latte lovers member's mug"]))));
  }

  advMacroAA($location(level_templateObject133 || (level_templateObject133 = level_taggedTemplateLiteral(["the haunted kitchen"]))), Macro.step(delevel).step(easyFight).step(candyblast).attack().repeat(), () => {
    return getCounters("Digitize", 0, 0).trim() !== "";
  });
  uniform();

  if (get("latteUnlocks").includes("chili")) {
    equip($slot(level_templateObject134 || (level_templateObject134 = level_taggedTemplateLiteral(["off-hand"]))), $item(level_templateObject135 || (level_templateObject135 = level_taggedTemplateLiteral(["familiar scrapbook"]))));
  }
...
function hybridize() {
  ...
  if ((0,dist.get)("_dnaHybrid") === false && (0,dist.get)("dnaSyringe") !== "fish") {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(level_templateObject137 || (level_templateObject137 = level_taggedTemplateLiteral(["ms puck man"]))));
    phredhccs_lib_advMacroAA((0,dist.$location)(level_templateObject138 || (level_templateObject138 = level_taggedTemplateLiteral(["The Bubblin' Caldera"]))), dist.Macro.while_("!monstername lava lamprey", dist.Macro.trySkill((0,dist.$skill)(level_templateObject139 || (level_templateObject139 = level_taggedTemplateLiteral(["Extract"])))).trySkill((0,dist.$skill)(level_templateObject140 || (level_templateObject140 = level_taggedTemplateLiteral(["Macrometeorite"]))))).if_("monstername lava lamprey", dist.Macro.trySkill((0,dist.$skill)(level_templateObject141 || (level_templateObject141 = level_taggedTemplateLiteral(["Extract"])))).item((0,dist.$item)(level_templateObject142 || (level_templateObject142 = level_taggedTemplateLiteral(["DNA extraction syringe"])))).skill((0,dist.$skill)(level_templateObject143 || (level_templateObject143 = level_taggedTemplateLiteral(["Feel Hatred"]))))), () => {
  ...
  if ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(level_templateObject144 || (level_templateObject144 = level_taggedTemplateLiteral(["Drenched in Lava"]))))) {
    (0,external_kolmafia_.cliExecute)("hottub");
  }
}
...
function prelude() {
  horse("dark");
  if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(level_templateObject145 || (level_templateObject145 = level_taggedTemplateLiteral(["astral six-pack"])))) !== 0) (0,external_kolmafia_.use)(1, (0,dist.$item)(level_templateObject146 || (level_templateObject146 = level_taggedTemplateLiteral(["astral six-pack"]))));
  if ((0,dist.have)((0,dist.$effect)(level_templateObject147 || (level_templateObject147 = level_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))))) (0,external_kolmafia_.cliExecute)("shrug The Magical Mojomuscular Melody");
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(level_templateObject148 || (level_templateObject148 = level_taggedTemplateLiteral(["The Ode to Booze"]))));

  while ((0,external_kolmafia_.myInebriety)() < 5) {
    (0,external_kolmafia_.drink)(1, (0,dist.$item)(level_templateObject149 || (level_templateObject149 = level_taggedTemplateLiteral(["astral pilsner"]))));
  }
}
/*
Buff Up
...
function levelUp() {
  ...
  initialExp();
  hybridize();
  tomatoJuiceAndNinjaCostume(); //getYoked();
  //digitwinked();
...
function getCrushed() {
  if (!(0,dist.have)((0,dist.$effect)(weapon_templateObject || (weapon_templateObject = weapon_taggedTemplateLiteral(["Do You Crush What I Crush?"]))))) {
    ...
    if (!(0,dist.have)((0,dist.$effect)(weapon_templateObject5 || (weapon_templateObject5 = weapon_taggedTemplateLiteral(["Holiday Yoked"]))))) {
      ...
      outfits_uniform();
      dist.Macro.item((0,dist.$item)(weapon_templateObject7 || (weapon_templateObject7 = weapon_taggedTemplateLiteral(["DNA extraction syringe"])))).step(phccs_macros_delevel).step(phccs_macros_easyFight).attack().repeat().setAutoAttack();
    ...
    geneTonic("elf");
    ensureEffect((0,dist.$effect)(weapon_templateObject8 || (weapon_templateObject8 = weapon_taggedTemplateLiteral(["human-elf hybrid"]))));
  }
}

function weapon_castBuffs() {
  (0,dist.$effects)(weapon_templateObject9 || (weapon_templateObject9 = weapon_taggedTemplateLiteral(["Carol of the Bulls, Song of the North, \n        Rage of the Reindeer, Scowl of the Auk, Disdain of the War Snapper, \n        Tenacity of the Snapper, Billiards Belligerence, Blessing of the Bird"]))).forEach(effect => ensureEffect(effect));
...
function kungFuMeteors() {
  if (!(0,dist.get)("_photocopyUsed")) {
    outfits_uniform();
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(weapon_templateObject14 || (weapon_templateObject14 = weapon_taggedTemplateLiteral(["Disembodied Hand"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(weapon_templateObject15 || (weapon_templateObject15 = weapon_taggedTemplateLiteral(["weapon"]))), (0,dist.$item)(weapon_templateObject16 || (weapon_templateObject16 = weapon_taggedTemplateLiteral(["none"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(weapon_templateObject17 || (weapon_templateObject17 = weapon_taggedTemplateLiteral(["off-hand"]))), (0,dist.$item)(weapon_templateObject18 || (weapon_templateObject18 = weapon_taggedTemplateLiteral(["none"]))));
    (0,external_kolmafia_.equip)((0,dist.$slot)(weapon_templateObject19 || (weapon_templateObject19 = weapon_taggedTemplateLiteral(["familiar"]))), (0,dist.$item)(weapon_templateObject20 || (weapon_templateObject20 = weapon_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
    setChoice(1387, 3);
    dist.Macro.skill((0,dist.$skill)(weapon_templateObject21 || (weapon_templateObject21 = weapon_taggedTemplateLiteral(["meteor shower"])))).skill((0,dist.$skill)(weapon_templateObject22 || (weapon_templateObject22 = weapon_taggedTemplateLiteral(["Use the Force"])))).setAutoAttack();
    fax((0,dist.$monster)(weapon_templateObject23 || (weapon_templateObject23 = weapon_taggedTemplateLiteral(["ungulith"]))));
    (0,external_kolmafia_.use)((0,dist.$item)(weapon_templateObject24 || (weapon_templateObject24 = weapon_taggedTemplateLiteral(["photocopied monster"]))));
    if ((0,external_kolmafia_.handlingChoice)()) (0,external_kolmafia_.runChoice)(-1);
    (0,dist.set)("_meteorShowerUses", 1 + (0,dist.get)("_meteorShowerUses"));
  }
}
...
function weapon_testPrep() {
  if ((0,dist.have)((0,dist.$item)(weapon_templateObject25 || (weapon_templateObject25 = weapon_taggedTemplateLiteral(["corrupted marrow"]))))) (0,external_kolmafia_.use)((0,dist.$item)(weapon_templateObject26 || (weapon_templateObject26 = weapon_taggedTemplateLiteral(["corrupted marrow"]))));
  if (!(0,dist.get)("_bowleggedSwaggerUsed")) (0,external_kolmafia_.useSkill)((0,dist.$skill)(weapon_templateObject27 || (weapon_templateObject27 = weapon_taggedTemplateLiteral(["Bow-Legged Swagger"]))));
  ;
