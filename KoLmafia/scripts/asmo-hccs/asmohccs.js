...
CommunityService_defineProperty(CommunityService_CommunityService, "HP", new CommunityService_CommunityService(1, "Donate Blood", () => 60 - Math.floor(((0,external_kolmafia_namespaceObject.myMaxhp)() - (0,external_kolmafia_namespaceObject.myBuffedstat)($stat(CommunityService_templateObject6 || (CommunityService_templateObject6 = CommunityService_taggedTemplateLiteral(["muscle"])))) - 3) / 30), new Requirement(["HP"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "Muscle", new CommunityService_CommunityService(2, "Feed The Children", statCommunityServicePredictor($stat(CommunityService_templateObject7 || (CommunityService_templateObject7 = CommunityService_taggedTemplateLiteral(["Muscle"])))), new Requirement(["Muscle"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "Mysticality", new CommunityService_CommunityService(3, "Build Playground Mazes", statCommunityServicePredictor($stat(CommunityService_templateObject8 || (CommunityService_templateObject8 = CommunityService_taggedTemplateLiteral(["Mysticality"])))), new Requirement(["Mysticality"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "Moxie", new CommunityService_CommunityService(4, "Feed Conspirators", statCommunityServicePredictor($stat(CommunityService_templateObject9 || (CommunityService_templateObject9 = CommunityService_taggedTemplateLiteral(["Moxie"])))), new Requirement(["Moxie"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "FamiliarWeight", new CommunityService_CommunityService(5, "Breed More Collies", () => 60 - Math.floor(((0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)()) + (0,external_kolmafia_namespaceObject.weightAdjustment)()) / 5), new Requirement(["Familiar Weight"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "WeaponDamage", new CommunityService_CommunityService(6, "Reduce Gazelle Population", () => {
  var weaponPower = (0,external_kolmafia_namespaceObject.getPower)((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(CommunityService_templateObject10 || (CommunityService_templateObject10 = CommunityService_taggedTemplateLiteral(["weapon"])))));
  var offhandPower = (0,external_kolmafia_namespaceObject.toSlot)((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(CommunityService_templateObject11 || (CommunityService_templateObject11 = CommunityService_taggedTemplateLiteral(["off-hand"]))))) === template_string_$slot(CommunityService_templateObject12 || (CommunityService_templateObject12 = CommunityService_taggedTemplateLiteral(["weapon"]))) ? (0,external_kolmafia_namespaceObject.getPower)((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(CommunityService_templateObject13 || (CommunityService_templateObject13 = CommunityService_taggedTemplateLiteral(["off-hand"]))))) : 0;
  var familiarPower = (0,external_kolmafia_namespaceObject.toSlot)((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(CommunityService_templateObject14 || (CommunityService_templateObject14 = CommunityService_taggedTemplateLiteral(["familiar"]))))) === template_string_$slot(CommunityService_templateObject15 || (CommunityService_templateObject15 = CommunityService_taggedTemplateLiteral(["weapon"]))) ? (0,external_kolmafia_namespaceObject.getPower)((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(CommunityService_templateObject16 || (CommunityService_templateObject16 = CommunityService_taggedTemplateLiteral(["familiar"]))))) : 0; // mafia does not currently count swagger
...
CommunityService_defineProperty(CommunityService_CommunityService, "SpellDamage", new CommunityService_CommunityService(7, "Make Sausage", () => {
...
CommunityService_defineProperty(CommunityService_CommunityService, "Noncombat", new CommunityService_CommunityService(8, "Be a Living Statue", () => {
...
CommunityService_defineProperty(CommunityService_CommunityService, "BoozeDrop", new CommunityService_CommunityService(9, "Make Margaritas", () => {
...
CommunityService_defineProperty(CommunityService_CommunityService, "HotRes", new CommunityService_CommunityService(10, "Clean Steam Tunnels", () => 60 - modifier_get("Hot Resistance"), new Requirement(["Hot Resistance"], {})));

CommunityService_defineProperty(CommunityService_CommunityService, "CoilWire", new CommunityService_CommunityService(11, "Coil Wire", () => 60, new Requirement([], {})));
...
function hpOutfit() {
  ...
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject63 || (_templateObject63 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$items(_templateObject64 || (_templateObject64 = outfits_taggedTemplateLiteral(["extra-wide head candle, wad of used tape"])))], [template_string_$slot(_templateObject65 || (_templateObject65 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject66 || (_templateObject66 = outfits_taggedTemplateLiteral(["dented scepter"])))], [template_string_$slot(_templateObject67 || (_templateObject67 = outfits_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject68 || (_templateObject68 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [template_string_$slot(_templateObject69 || (_templateObject69 = outfits_taggedTemplateLiteral(["shirt"]))), template_string_$items(_templateObject70 || (_templateObject70 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"])))], [template_string_$slot(_templateObject71 || (_templateObject71 = outfits_taggedTemplateLiteral(["back"]))), template_string_$items(_templateObject72 || (_templateObject72 = outfits_taggedTemplateLiteral(["vampyric cloake, unwrapped knock-off retro superhero cape"])))], [template_string_$slot(_templateObject73 || (_templateObject73 = outfits_taggedTemplateLiteral(["pants"]))), template_string_$item(_templateObject74 || (_templateObject74 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [template_string_$slot(_templateObject75 || (_templateObject75 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$item(_templateObject76 || (_templateObject76 = outfits_taggedTemplateLiteral(["Powerful Glove"])))], [template_string_$slot(_templateObject77 || (_templateObject77 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject78 || (_templateObject78 = outfits_taggedTemplateLiteral(["Retrospecs"])))], [template_string_$slot(_templateObject79 || (_templateObject79 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject80 || (_templateObject80 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [template_string_$slot(_templateObject81 || (_templateObject81 = outfits_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject82 || (_templateObject82 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))]])).dress();
}
function muscleOutfit() {
  ...
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject84 || (_templateObject84 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$item(_templateObject85 || (_templateObject85 = outfits_taggedTemplateLiteral(["wad of used tape"])))], [template_string_$slot(_templateObject86 || (_templateObject86 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject87 || (_templateObject87 = outfits_taggedTemplateLiteral(["dented scepter"])))], [template_string_$slot(_templateObject88 || (_templateObject88 = outfits_taggedTemplateLiteral(["off-hand"]))), lib_have(template_string_$familiar(_templateObject89 || (_templateObject89 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$item(_templateObject90 || (_templateObject90 = outfits_taggedTemplateLiteral(["cosmetic football"]))) : template_string_$item(_templateObject91 || (_templateObject91 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [template_string_$slot(_templateObject92 || (_templateObject92 = outfits_taggedTemplateLiteral(["shirt"]))), template_string_$items(_templateObject93 || (_templateObject93 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"])))], [template_string_$slot(_templateObject94 || (_templateObject94 = outfits_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject95 || (_templateObject95 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [template_string_$slot(_templateObject96 || (_templateObject96 = outfits_taggedTemplateLiteral(["pants"]))), template_string_$item(_templateObject97 || (_templateObject97 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [template_string_$slot(_templateObject98 || (_templateObject98 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$item(_templateObject99 || (_templateObject99 = outfits_taggedTemplateLiteral(["Brutal brogues"])))], [template_string_$slot(_templateObject100 || (_templateObject100 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject101 || (_templateObject101 = outfits_taggedTemplateLiteral(["Retrospecs"])))], [template_string_$slot(_templateObject102 || (_templateObject102 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject103 || (_templateObject103 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [template_string_$slot(_templateObject104 || (_templateObject104 = outfits_taggedTemplateLiteral(["familiar"]))), lib_have(template_string_$familiar(_templateObject105 || (_templateObject105 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$item(_templateObject106 || (_templateObject106 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))) : template_string_$item(_templateObject107 || (_templateObject107 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))]]), lib_have(template_string_$familiar(_templateObject108 || (_templateObject108 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$familiar(_templateObject109 || (_templateObject109 = outfits_taggedTemplateLiteral(["Disembodied Hand"]))) : undefined).dress();
}
function mysticalityOutfit() {
  (0,external_kolmafia_namespaceObject.cliExecute)("retrocape heck");
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject110 || (_templateObject110 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$items(_templateObject111 || (_templateObject111 = outfits_taggedTemplateLiteral(["astral chapeau, wad of used tape"])))], [template_string_$slot(_templateObject112 || (_templateObject112 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$items(_templateObject113 || (_templateObject113 = outfits_taggedTemplateLiteral(["weeping willow wand"])))], [template_string_$slot(_templateObject114 || (_templateObject114 = outfits_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject115 || (_templateObject115 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [template_string_$slot(_templateObject116 || (_templateObject116 = outfits_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject117 || (_templateObject117 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [template_string_$slot(_templateObject118 || (_templateObject118 = outfits_taggedTemplateLiteral(["shirt"]))), template_string_$items(_templateObject119 || (_templateObject119 = outfits_taggedTemplateLiteral(["denim jacket, shoe ad T-shirt, fresh coat of paint"])))], [template_string_$slot(_templateObject120 || (_templateObject120 = outfits_taggedTemplateLiteral(["pants"]))), template_string_$items(_templateObject121 || (_templateObject121 = outfits_taggedTemplateLiteral(["cargo cultist shorts, pantogram pants"])))], [template_string_$slot(_templateObject122 || (_templateObject122 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$item(_templateObject123 || (_templateObject123 = outfits_taggedTemplateLiteral(["retrospecs"])))], //TODO See if there is anything better
  [template_string_$slot(_templateObject124 || (_templateObject124 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject125 || (_templateObject125 = outfits_taggedTemplateLiteral(["codpiece"])))], [template_string_$slot(_templateObject126 || (_templateObject126 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject127 || (_templateObject127 = outfits_taggedTemplateLiteral(["battle broom"])))], [template_string_$slot(_templateObject128 || (_templateObject128 = outfits_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject129 || (_templateObject129 = outfits_taggedTemplateLiteral(["Abracandalabra"])))]]), template_string_$familiar(_templateObject130 || (_templateObject130 = outfits_taggedTemplateLiteral(["Left-Hand Man"])))).dress();
}
function itemOutfit() {
  ...
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject132 || (_templateObject132 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$item(_templateObject133 || (_templateObject133 = outfits_taggedTemplateLiteral(["wad of used tape"])))], [template_string_$slot(_templateObject134 || (_templateObject134 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$items(_templateObject135 || (_templateObject135 = outfits_taggedTemplateLiteral(["extra-large utility candle, runed taper candle, novelty sparkling candle"])))], [template_string_$slot(_templateObject136 || (_templateObject136 = outfits_taggedTemplateLiteral(["off-hand"]))), template_string_$items(_templateObject137 || (_templateObject137 = outfits_taggedTemplateLiteral(["Cursed Magnifying Glass, Kramco Sausage-o-Matic\u2122"])))], //TODO Add Cursed Magnifying Glass once implemented in Mafia
  [template_string_$slot(_templateObject138 || (_templateObject138 = outfits_taggedTemplateLiteral(["back"]))), template_string_$items(_templateObject139 || (_templateObject139 = outfits_taggedTemplateLiteral(["vampyric cloake, protonic accelerator pack"])))], [template_string_$slot(_templateObject140 || (_templateObject140 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$item(_templateObject141 || (_templateObject141 = outfits_taggedTemplateLiteral(["Guzzlr tablet"])))], [template_string_$slot(_templateObject142 || (_templateObject142 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject143 || (_templateObject143 = outfits_taggedTemplateLiteral(["gold detective badge"])))], [template_string_$slot(_templateObject144 || (_templateObject144 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$items(_templateObject145 || (_templateObject145 = outfits_taggedTemplateLiteral(["your cowboy boots, government-issued night-vision goggles"])))], [template_string_$slot(_templateObject146 || (_templateObject146 = outfits_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject147 || (_templateObject147 = outfits_taggedTemplateLiteral(["li'l ninja costume"])))]]), template_string_$familiar(_templateObject148 || (_templateObject148 = outfits_taggedTemplateLiteral(["Trick-or-Treating Tot"])))).dress();
}
function hotresOutfit() {
  (0,external_kolmafia_namespaceObject.cliExecute)("retrocape vampire hold");
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject149 || (_templateObject149 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$items(_templateObject150 || (_templateObject150 = outfits_taggedTemplateLiteral(["high-temperature mining mask, Iunion crown"])))], [template_string_$slot(_templateObject151 || (_templateObject151 = outfits_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject152 || (_templateObject152 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [template_string_$slot(_templateObject153 || (_templateObject153 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$items(_templateObject154 || (_templateObject154 = outfits_taggedTemplateLiteral(["industrial fire extinguisher, Fourth of May Cosplay Saber"])))], [template_string_$slot(_templateObject155 || (_templateObject155 = outfits_taggedTemplateLiteral(["off-hand"]))), template_string_$items(_templateObject156 || (_templateObject156 = outfits_taggedTemplateLiteral(["meteorite guard, latte lovers member's mug"])))], [template_string_$slot(_templateObject157 || (_templateObject157 = outfits_taggedTemplateLiteral(["pants"]))), template_string_$items(_templateObject158 || (_templateObject158 = outfits_taggedTemplateLiteral(["lava-proof pants, pantogram pants"])))], [template_string_$slot(_templateObject159 || (_templateObject159 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$items(_templateObject160 || (_templateObject160 = outfits_taggedTemplateLiteral(["heat-resistant necktie, brutal brogues"])))], [template_string_$slot(_templateObject161 || (_templateObject161 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject162 || (_templateObject162 = outfits_taggedTemplateLiteral(["heat-resistant gloves"])))], [template_string_$slot(_templateObject163 || (_templateObject163 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject164 || (_templateObject164 = outfits_taggedTemplateLiteral(["Beach Comb"])))], [template_string_$slot(_templateObject165 || (_templateObject165 = outfits_taggedTemplateLiteral(["familiar"]))), template_string_$items(_templateObject166 || (_templateObject166 = outfits_taggedTemplateLiteral(["snow suit, cracker"])))]]), template_string_$familiar(_templateObject167 || (_templateObject167 = outfits_taggedTemplateLiteral(["Exotic Parrot"])))).dress();
}
function noncombatOutfit() {
  Outfit.doYourBest(new Map([[template_string_$slot(_templateObject168 || (_templateObject168 = outfits_taggedTemplateLiteral(["hat"]))), template_string_$item(_templateObject169 || (_templateObject169 = outfits_taggedTemplateLiteral(["very pointy crown"])))], [template_string_$slot(_templateObject170 || (_templateObject170 = outfits_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject171 || (_templateObject171 = outfits_taggedTemplateLiteral(["protonic accelerator pack"])))], [template_string_$slot(_templateObject172 || (_templateObject172 = outfits_taggedTemplateLiteral(["weapon"]))), template_string_$items(_templateObject173 || (_templateObject173 = outfits_taggedTemplateLiteral(["fish hatchet, Fourth of May Cosplay Saber"])))], [template_string_$slot(_templateObject174 || (_templateObject174 = outfits_taggedTemplateLiteral(["off-hand"]))), template_string_$items(_templateObject175 || (_templateObject175 = outfits_taggedTemplateLiteral(["rope, burning paper crane, familiar scrapbook"])))], //[$slot`pants`, $item`pantogram pants`],
  [template_string_$slot(_templateObject176 || (_templateObject176 = outfits_taggedTemplateLiteral(["acc1"]))), template_string_$item(_templateObject177 || (_templateObject177 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [template_string_$slot(_templateObject178 || (_templateObject178 = outfits_taggedTemplateLiteral(["acc2"]))), template_string_$item(_templateObject179 || (_templateObject179 = outfits_taggedTemplateLiteral(["codpiece"])))], [template_string_$slot(_templateObject180 || (_templateObject180 = outfits_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject181 || (_templateObject181 = outfits_taggedTemplateLiteral(["Brutal brogues"])))]]), template_string_$familiar(_templateObject182 || (_templateObject182 = outfits_taggedTemplateLiteral(["Disgeist"])))).dress();
}
function famweightOutfit() {
  var familiarAndEquip = !(0,external_kolmafia_namespaceObject.inHardcore)() ? {
    fam: template_string_$familiar(_templateObject183 || (_templateObject183 = outfits_taggedTemplateLiteral(["Exotic Parrot"]))),
    equip: template_string_$item(_templateObject184 || (_templateObject184 = outfits_taggedTemplateLiteral(["snow suit"])))
  } : lib_have(template_string_$item(_templateObject185 || (_templateObject185 = outfits_taggedTemplateLiteral(["cracker"])))) ? {
    fam: template_string_$familiar(_templateObject186 || (_templateObject186 = outfits_taggedTemplateLiteral(["Exotic Parrot"]))),
  ...
  resources_createClass(ResourceTracker, [{
    ...
    value: function deserialize(data) {
      ...
      result.tomeSummons = tomeSummons ? tomeSummons.map(name => {
        ...
        return skill !== $skill(resources_templateObject4 || (resources_templateObject4 = resources_taggedTemplateLiteral(["none"]))) ? skill : item;
      }) : [];
...
function modTraceList(modifier) {
  ...
  var _iterator = modtrace_createForOfIteratorHelper($slots(modtrace_templateObject4 || (modtrace_templateObject4 = modtrace_taggedTemplateLiteral([""])))),
      _step;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if ((0,external_kolmafia_namespaceObject.numericModifier)(it, modifier) != 0 && ((0,external_kolmafia_namespaceObject.haveEquipped)(it) || (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(modtrace_templateObject5 || (modtrace_templateObject5 = modtrace_taggedTemplateLiteral(["your cowboy boots"])))) && $slots(modtrace_templateObject6 || (modtrace_templateObject6 = modtrace_taggedTemplateLiteral(["bootspur, bootskin"]))).includes(slot) || (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(modtrace_templateObject7 || (modtrace_templateObject7 = modtrace_taggedTemplateLiteral(["over-the-shoulder folder holder"])))) && slot.toString().includes("folder") || ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(modtrace_templateObject8 || (modtrace_templateObject8 = modtrace_taggedTemplateLiteral(["scratch 'n' sniff sword"])))) || (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(modtrace_templateObject9 || (modtrace_templateObject9 = modtrace_taggedTemplateLiteral(["scratch 'n' sniff crossbow"]))))) && slot.toString().includes("sticker"))) {
      ...
      if ((0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(modtrace_templateObject10 || (modtrace_templateObject10 = modtrace_taggedTemplateLiteral(["back"])))) == template_string_$item(modtrace_templateObject11 || (modtrace_templateObject11 = modtrace_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) {
        ...
        if (capeForm === "vampire") {
          if (["hot resistance", "cold resistance", "sleaze resistance", "spooky resistance", "stench resistance"].includes(modifier) && capeWash === "hold") {
            totalVal = totalVal + 3;
            (0,external_kolmafia_namespaceObject.print)("RETROCAPE " + capeForm + " " + capeWash + " : " + 3);
          } else if (modifier === "muscle percent") {
            totalVal = totalVal + 30;
            (0,external_kolmafia_namespaceObject.print)("RETROCAPE " + capeForm + " " + capeWash + " : " + 30);
          } else if (modifier === "maximum hp") {
            totalVal = totalVal + 50;
            (0,external_kolmafia_namespaceObject.print)("RETROCAPE " + capeForm + " " + capeWash + " : " + 50);
          }
          ...
          if (modifier === "moxie percent") {
            ...
            (0,external_kolmafia_namespaceObject.print)("RETROCAPE " + capeForm + " " + capeWash + " : " + 25);
          }
        }
      }
    }
  ...
  if (modifier.includes("experience percent")) {
    if (modifier.includes("muscle") && (0,external_kolmafia_namespaceObject.inMuscleSign)()) {
      ...
      if (modifier.includes("weapon") && myMoon === "Mongoose") {
        ...
        (0,external_kolmafia_namespaceObject.print)("MOON " + myMoon + " : " + 20);
      ...
      totalVal = totalVal + 5;
      (0,external_kolmafia_namespaceObject.print)("MOON " + myMoon + " : " + 5);
    }
  ...
  if (horsery() !== "" && property_get("horseryAvailable")) {
    ...
    if (modifier.includes("init") && myHorse.includes("normal")) {
      totalVal = totalVal + 10;
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : " + 10);
    } else if (modifier.includes("combat") && myHorse.includes("dark")) {
      totalVal = totalVal - 5;
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : -5");
      ...
      totalVal = totalVal + 1;
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : " + 1);
      ...
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : " + property_get("_horseryCrazyMox"));
      ...
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : " + property_get("_horseryCrazyMus"));
      ...
      (0,external_kolmafia_namespaceObject.print)("HORSERY " + myHorse + " : " + property_get("_horseryCrazyMys"));
    }
  }

  var squint = template_string_$effect(modtrace_templateObject2 || (modtrace_templateObject2 = modtrace_taggedTemplateLiteral(["Steely-Eyed Squint"])));
  var swagger = template_string_$effect(modtrace_templateObject3 || (modtrace_templateObject3 = modtrace_taggedTemplateLiteral(["Bow-Legged Swagger"])));
...
function synthMysExp() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject || (synthesis_templateObject = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  }
  ...
  if (fudges >= 2) {
    ...
    if (!lib_have(template_string_$effect(synthesis_templateObject6 || (synthesis_templateObject6 = synthesis_taggedTemplateLiteral(["Synthesis: Learning"]))))) {
      if (!lib_have(template_string_$item(synthesis_templateObject7 || (synthesis_templateObject7 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))))) {
        if (!lib_have(template_string_$item(synthesis_templateObject8 || (synthesis_templateObject8 = synthesis_taggedTemplateLiteral(["sugar sheet"]))))) (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject9 || (synthesis_templateObject9 = synthesis_taggedTemplateLiteral(["sugar sheet"]))));
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject10 || (synthesis_templateObject10 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject11 || (synthesis_templateObject11 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject12 || (synthesis_templateObject12 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))), template_string_$item(synthesis_templateObject13 || (synthesis_templateObject13 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))));
      }
    }
  }

  if (!lib_have(template_string_$effect(synthesis_templateObject14 || (synthesis_templateObject14 = synthesis_taggedTemplateLiteral(["Synthesis: Learning"]))))) {
...
function synthMusExp() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject15 || (synthesis_templateObject15 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  }

  var fudge = template_string_$item(synthesis_templateObject16 || (synthesis_templateObject16 = synthesis_taggedTemplateLiteral(["Crimbo fudge"])));
  var pecan = template_string_$item(synthesis_templateObject17 || (synthesis_templateObject17 = synthesis_taggedTemplateLiteral(["Crimbo candied pecan"])));
  var bark = template_string_$item(synthesis_templateObject18 || (synthesis_templateObject18 = synthesis_taggedTemplateLiteral(["Crimbo peppermint bark"])));
  var fudges = (0,external_kolmafia_namespaceObject.availableAmount)(fudge);
  var pecans = (0,external_kolmafia_namespaceObject.availableAmount)(pecan);
  var barks = (0,external_kolmafia_namespaceObject.availableAmount)(bark);
  var twist = template_string_$item(synthesis_templateObject19 || (synthesis_templateObject19 = synthesis_taggedTemplateLiteral(["peppermint twist"])));
  var twists = (0,external_kolmafia_namespaceObject.availableAmount)(twist);
  var sprout = template_string_$item(synthesis_templateObject20 || (synthesis_templateObject20 = synthesis_taggedTemplateLiteral(["peppermint sprout"])));
  ...
  if (fudges >= 1 && barks >= 1) {
    ...
    if (!lib_have(template_string_$effect(synthesis_templateObject21 || (synthesis_templateObject21 = synthesis_taggedTemplateLiteral(["Synthesis: Movement"]))))) {
      if (fudges >= 1) {
        if (!lib_have(template_string_$item(synthesis_templateObject22 || (synthesis_templateObject22 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))))) {
          if (!lib_have(template_string_$item(synthesis_templateObject23 || (synthesis_templateObject23 = synthesis_taggedTemplateLiteral(["sugar sheet"]))))) (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject24 || (synthesis_templateObject24 = synthesis_taggedTemplateLiteral(["sugar sheet"]))));
          (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject25 || (synthesis_templateObject25 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))));
        }

        (0,external_kolmafia_namespaceObject.sweetSynthesis)(fudge, template_string_$item(synthesis_templateObject26 || (synthesis_templateObject26 = synthesis_taggedTemplateLiteral(["sugar shotgun"]))));
      }

      if (!lib_have(template_string_$item(synthesis_templateObject27 || (synthesis_templateObject27 = synthesis_taggedTemplateLiteral(["sugar shorts"]))))) {
        ...
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject30 || (synthesis_templateObject30 = synthesis_taggedTemplateLiteral(["sugar shorts"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject31 || (synthesis_templateObject31 = synthesis_taggedTemplateLiteral(["sugar shorts"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject32 || (synthesis_templateObject32 = synthesis_taggedTemplateLiteral(["sugar shorts"]))), sprout);
      }
    }
  }

  if (!lib_have(template_string_$effect(synthesis_templateObject33 || (synthesis_templateObject33 = synthesis_taggedTemplateLiteral(["Synthesis: Movement"]))))) {
...
function synthMoxExp() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject34 || (synthesis_templateObject34 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  }

  var fudge = template_string_$item(synthesis_templateObject35 || (synthesis_templateObject35 = synthesis_taggedTemplateLiteral(["Crimbo fudge"])));
  var pecan = template_string_$item(synthesis_templateObject36 || (synthesis_templateObject36 = synthesis_taggedTemplateLiteral(["Crimbo candied pecan"])));
  var bark = template_string_$item(synthesis_templateObject37 || (synthesis_templateObject37 = synthesis_taggedTemplateLiteral(["Crimbo peppermint bark"])));
  var fudges = (0,external_kolmafia_namespaceObject.availableAmount)(fudge);
  var pecans = (0,external_kolmafia_namespaceObject.availableAmount)(pecan);
  var barks = (0,external_kolmafia_namespaceObject.availableAmount)(bark);
  var twist = template_string_$item(synthesis_templateObject38 || (synthesis_templateObject38 = synthesis_taggedTemplateLiteral(["peppermint twist"])));
  var twists = (0,external_kolmafia_namespaceObject.availableAmount)(twist);
  var sprout = template_string_$item(synthesis_templateObject39 || (synthesis_templateObject39 = synthesis_taggedTemplateLiteral(["peppermint sprout"])));
  ...
  if (fudges >= 1) {
  ...
  } else if (lib_have(template_string_$item(synthesis_templateObject40 || (synthesis_templateObject40 = synthesis_taggedTemplateLiteral(["bag of many confections"])))) && pecans >= 1) {
    (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject41 || (synthesis_templateObject41 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
  } else {
    gingerCandy(); //Section below stolen from Bean (with edits)
    ...
    if (!lib_have(template_string_$effect(synthesis_templateObject42 || (synthesis_templateObject42 = synthesis_taggedTemplateLiteral(["Synthesis: Style"]))))) {
      if (!lib_have(template_string_$item(synthesis_templateObject43 || (synthesis_templateObject43 = synthesis_taggedTemplateLiteral(["sugar shillelagh"]))))) {
        if (!lib_have(template_string_$item(synthesis_templateObject44 || (synthesis_templateObject44 = synthesis_taggedTemplateLiteral(["sugar sheet"]))))) (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject45 || (synthesis_templateObject45 = synthesis_taggedTemplateLiteral(["sugar sheet"]))));
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject46 || (synthesis_templateObject46 = synthesis_taggedTemplateLiteral(["sugar shillelagh"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject47 || (synthesis_templateObject47 = synthesis_taggedTemplateLiteral(["sugar shillelagh"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject48 || (synthesis_templateObject48 = synthesis_taggedTemplateLiteral(["sugar shillelagh"]))), template_string_$item(synthesis_templateObject49 || (synthesis_templateObject49 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))));
      }
    }
  }

  if (!lib_have(template_string_$effect(synthesis_templateObject50 || (synthesis_templateObject50 = synthesis_taggedTemplateLiteral(["Synthesis: Style"]))))) {
...
function synthItem() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject51 || (synthesis_templateObject51 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  }

  var fudge = template_string_$item(synthesis_templateObject52 || (synthesis_templateObject52 = synthesis_taggedTemplateLiteral(["Crimbo fudge"])));
  var pecan = template_string_$item(synthesis_templateObject53 || (synthesis_templateObject53 = synthesis_taggedTemplateLiteral(["Crimbo candied pecan"])));
  var bark = template_string_$item(synthesis_templateObject54 || (synthesis_templateObject54 = synthesis_taggedTemplateLiteral(["Crimbo peppermint bark"])));
  var fudges = (0,external_kolmafia_namespaceObject.availableAmount)(fudge);
  var pecans = (0,external_kolmafia_namespaceObject.availableAmount)(pecan);
  var barks = (0,external_kolmafia_namespaceObject.availableAmount)(bark);
  ...
  if (inMysClass()) {
    if (barks > 2) {
      ...
      if (!lib_have(template_string_$item(synthesis_templateObject55 || (synthesis_templateObject55 = synthesis_taggedTemplateLiteral(["peppermint twist"]))))) {
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject56 || (synthesis_templateObject56 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject57 || (synthesis_templateObject57 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject58 || (synthesis_templateObject58 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(synthesis_templateObject59 || (synthesis_templateObject59 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }
    }
  } else if (inMusClass()) {
    if (barks >= 2 && fudges == 0) {
      ...
      if (!lib_have(template_string_$item(synthesis_templateObject60 || (synthesis_templateObject60 = synthesis_taggedTemplateLiteral(["peppermint twist"]))))) {
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject61 || (synthesis_templateObject61 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject62 || (synthesis_templateObject62 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject63 || (synthesis_templateObject63 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(synthesis_templateObject64 || (synthesis_templateObject64 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }
    }
  } else if (inMoxClass()) {
    if (barks >= 2 && pecans == 0) {
      ...
      if (!lib_have(template_string_$item(synthesis_templateObject65 || (synthesis_templateObject65 = synthesis_taggedTemplateLiteral(["peppermint twist"]))))) {
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject66 || (synthesis_templateObject66 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }

      if (pecans >= 1) {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(pecan, template_string_$item(synthesis_templateObject67 || (synthesis_templateObject67 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      } else {
        (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject68 || (synthesis_templateObject68 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(synthesis_templateObject69 || (synthesis_templateObject69 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }
    }
  }

  if (!lib_have(template_string_$effect(synthesis_templateObject70 || (synthesis_templateObject70 = synthesis_taggedTemplateLiteral(["Synthesis: Collection"]))))) {
...
function synthMyst() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject71 || (synthesis_templateObject71 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  ...
  if (lib_have(template_string_$item(synthesis_templateObject72 || (synthesis_templateObject72 = synthesis_taggedTemplateLiteral(["bag of many confections"]))))) {
    if (!property_get("_chubbyAndPlumpUsed")) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject73 || (synthesis_templateObject73 = synthesis_taggedTemplateLiteral(["Chubby and Plump"]))));
    }

    (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject74 || (synthesis_templateObject74 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"]))), template_string_$item(synthesis_templateObject75 || (synthesis_templateObject75 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
  } else {
    var mint = template_string_$item(synthesis_templateObject76 || (synthesis_templateObject76 = synthesis_taggedTemplateLiteral(["Senior Mints"])));
    var mints = (0,external_kolmafia_namespaceObject.availableAmount)(mint);
    var orangeHeart = template_string_$item(synthesis_templateObject77 || (synthesis_templateObject77 = synthesis_taggedTemplateLiteral(["orange candy heart"])));

    var orangeHearts = () => (0,external_kolmafia_namespaceObject.availableAmount)(orangeHeart);

    var pinkHeart = template_string_$item(synthesis_templateObject78 || (synthesis_templateObject78 = synthesis_taggedTemplateLiteral(["pink candy heart"])));

    var pinkHearts = () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(synthesis_templateObject79 || (synthesis_templateObject79 = synthesis_taggedTemplateLiteral(["pink candy heart"]))));

    var n = 0;

    while (mints + orangeHearts() + pinkHearts() === 0 && n < 11) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject80 || (synthesis_templateObject80 = synthesis_taggedTemplateLiteral(["Summon Candy Heart"]))));
      n++;
    }
    ...
    if (mints >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(mint, template_string_$item(synthesis_templateObject81 || (synthesis_templateObject81 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))));
    } else if (orangeHearts() >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(orangeHeart, template_string_$item(synthesis_templateObject82 || (synthesis_templateObject82 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))));
    } else if (pinkHearts() >= 1) {
      if (!lib_have(template_string_$item(synthesis_templateObject83 || (synthesis_templateObject83 = synthesis_taggedTemplateLiteral(["peppermint twist"]))))) {
        (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(synthesis_templateObject84 || (synthesis_templateObject84 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
      }

      (0,external_kolmafia_namespaceObject.sweetSynthesis)(pinkHeart, template_string_$item(synthesis_templateObject85 || (synthesis_templateObject85 = synthesis_taggedTemplateLiteral(["peppermint twist"]))));
    }
  }

  if ((0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(synthesis_templateObject86 || (synthesis_templateObject86 = synthesis_taggedTemplateLiteral(["Synthesis: Smart"])))) === 0) {
...
function synthMus() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject87 || (synthesis_templateObject87 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  } //const fudge = $item`Crimbo fudge`;
  //const pecan = $item`Crimbo candied pecan`;


  var bark = template_string_$item(synthesis_templateObject88 || (synthesis_templateObject88 = synthesis_taggedTemplateLiteral(["Crimbo peppermint bark"]))); //const fudges = availableAmount(fudge);
  //const pecans = availableAmount(pecan);

  var barks = (0,external_kolmafia_namespaceObject.availableAmount)(bark);

  if (!property_get("_chubbyAndPlumpUsed")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject89 || (synthesis_templateObject89 = synthesis_taggedTemplateLiteral(["Chubby and Plump"]))));
  }

  if (lib_have(template_string_$item(synthesis_templateObject90 || (synthesis_templateObject90 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"])))) && barks >= 2) {
    (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject91 || (synthesis_templateObject91 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"]))), bark);
  } else if (lib_have(template_string_$item(synthesis_templateObject92 || (synthesis_templateObject92 = synthesis_taggedTemplateLiteral(["bag of many confections"]))))) {
    var mint = template_string_$item(synthesis_templateObject93 || (synthesis_templateObject93 = synthesis_taggedTemplateLiteral(["Senior Mints"])));
    var mints = (0,external_kolmafia_namespaceObject.availableAmount)(mint);
    var orangeHeart = template_string_$item(synthesis_templateObject94 || (synthesis_templateObject94 = synthesis_taggedTemplateLiteral(["orange candy heart"])));

    var orangeHearts = () => (0,external_kolmafia_namespaceObject.availableAmount)(orangeHeart);

    var pinkHeart = template_string_$item(synthesis_templateObject95 || (synthesis_templateObject95 = synthesis_taggedTemplateLiteral(["pink candy heart"])));

    var pinkHearts = () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(synthesis_templateObject96 || (synthesis_templateObject96 = synthesis_taggedTemplateLiteral(["pink candy heart"]))));

    var n = 0;

    while (mints + orangeHearts() === 0 && n < 11) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject97 || (synthesis_templateObject97 = synthesis_taggedTemplateLiteral(["Summon Candy Heart"]))));
      n++;
    }
    ...
    if (mints >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(mint, template_string_$item(synthesis_templateObject98 || (synthesis_templateObject98 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
    } else if (orangeHearts() >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(orangeHeart, template_string_$item(synthesis_templateObject99 || (synthesis_templateObject99 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
    } else if (pinkHearts() >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(pinkHeart, template_string_$item(synthesis_templateObject100 || (synthesis_templateObject100 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))));
    }
  }

  if ((0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(synthesis_templateObject101 || (synthesis_templateObject101 = synthesis_taggedTemplateLiteral(["Synthesis: Strong"])))) === 0) {
...
function synthMox() {
  ...
  if (!property_get("_candySummons")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject102 || (synthesis_templateObject102 = synthesis_taggedTemplateLiteral(["Summon Crimbo Candy"]))));
  }

  var fudge = template_string_$item(synthesis_templateObject103 || (synthesis_templateObject103 = synthesis_taggedTemplateLiteral(["Crimbo fudge"])));
  var pecan = template_string_$item(synthesis_templateObject104 || (synthesis_templateObject104 = synthesis_taggedTemplateLiteral(["Crimbo candied pecan"])));
  var bark = template_string_$item(synthesis_templateObject105 || (synthesis_templateObject105 = synthesis_taggedTemplateLiteral(["Crimbo peppermint bark"])));
  var fudges = (0,external_kolmafia_namespaceObject.availableAmount)(fudge);
  var pecans = (0,external_kolmafia_namespaceObject.availableAmount)(pecan);
  var barks = (0,external_kolmafia_namespaceObject.availableAmount)(bark);

  if (!property_get("_chubbyAndPlumpUsed")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject106 || (synthesis_templateObject106 = synthesis_taggedTemplateLiteral(["Chubby and Plump"]))));
  }

  if (pecans >= 1) {
    (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject107 || (synthesis_templateObject107 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"]))), pecan);
  } else if (fudges > 1 && lib_have(template_string_$item(synthesis_templateObject108 || (synthesis_templateObject108 = synthesis_taggedTemplateLiteral(["bag of many confections"]))))) {
    var taffy = template_string_$item(synthesis_templateObject109 || (synthesis_templateObject109 = synthesis_taggedTemplateLiteral(["Daffy Taffy"])));
    var taffys = (0,external_kolmafia_namespaceObject.availableAmount)(taffy);
    var candy = template_string_$item(synthesis_templateObject110 || (synthesis_templateObject110 = synthesis_taggedTemplateLiteral(["Cold Hots candy"])));
    var candys = (0,external_kolmafia_namespaceObject.availableAmount)(candy);
    var yellowHeart = template_string_$item(synthesis_templateObject111 || (synthesis_templateObject111 = synthesis_taggedTemplateLiteral(["yellow candy heart"])));
    ...
    while (taffys + yellowHearts() + candys === 0 && n < 11) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, $skill(synthesis_templateObject112 || (synthesis_templateObject112 = synthesis_taggedTemplateLiteral(["Summon Candy Heart"]))));
      n++;
    }
    ...
    if (taffys >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(taffy, template_string_$item(synthesis_templateObject113 || (synthesis_templateObject113 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
    } else if (yellowHearts() >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(yellowHeart, template_string_$item(synthesis_templateObject114 || (synthesis_templateObject114 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
    } else if (candys >= 1) {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(candy, template_string_$item(synthesis_templateObject115 || (synthesis_templateObject115 = synthesis_taggedTemplateLiteral(["bag of many confections"]))));
    } else {
      (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject116 || (synthesis_templateObject116 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(synthesis_templateObject117 || (synthesis_templateObject117 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"]))));
    }
  } else if (barks >= 1) {
    (0,external_kolmafia_namespaceObject.sweetSynthesis)(template_string_$item(synthesis_templateObject118 || (synthesis_templateObject118 = synthesis_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(synthesis_templateObject119 || (synthesis_templateObject119 = synthesis_taggedTemplateLiteral(["Chubby and Plump bar"]))));
  }

  if ((0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(synthesis_templateObject120 || (synthesis_templateObject120 = synthesis_taggedTemplateLiteral(["Synthesis: Cool"])))) === 0) {
...
function noncombat_testPrep() {
  ...
  }, () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(noncombat_templateObject28 || (noncombat_templateObject28 = noncombat_taggedTemplateLiteral(["shady shades"]))))];
...
function moonTune() {
  ...
  var desertAccessItem = (0,external_kolmafia_namespaceObject.knollAvailable)() ? template_string_$item(noncombat_templateObject29 || (noncombat_templateObject29 = noncombat_taggedTemplateLiteral(["bitchin' meatcar"]))) : template_string_$item(noncombat_templateObject30 || (noncombat_templateObject30 = noncombat_taggedTemplateLiteral(["Desert Bus pass"])));
  ...
  if (!property_get("moonTuned") && (0,external_kolmafia_namespaceObject.mySign)() !== "Platypus") {
    ...
    (0,external_kolmafia_namespaceObject.equip)(template_string_$slot(noncombat_templateObject31 || (noncombat_templateObject31 = noncombat_taggedTemplateLiteral(["acc1"]))), template_string_$item(noncombat_templateObject32 || (noncombat_templateObject32 = noncombat_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"]))));
    (0,external_kolmafia_namespaceObject.equip)(template_string_$slot(noncombat_templateObject33 || (noncombat_templateObject33 = noncombat_taggedTemplateLiteral(["acc2"]))), template_string_$item(noncombat_templateObject34 || (noncombat_templateObject34 = noncombat_taggedTemplateLiteral(["Powerful Glove"]))));
    (0,external_kolmafia_namespaceObject.equip)(template_string_$slot(noncombat_templateObject35 || (noncombat_templateObject35 = noncombat_taggedTemplateLiteral(["acc3"]))), template_string_$item(noncombat_templateObject36 || (noncombat_templateObject36 = noncombat_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))); // Actually tune the moon.
