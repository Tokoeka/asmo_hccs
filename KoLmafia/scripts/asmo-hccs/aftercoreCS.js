...
function fillTo(targetUnits) {
  ...
  while ((0,external_kolmafia_namespaceObject.getFuel)() < targetUnits) {
    ...
    if (secondBest) {
      ...
      var ceiling = Math.ceil(efficiencyOfSecondBest * lib_getAverageAdventures(bestFuel));
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    var familiarEquip = entry.equipment.get(template_string_$slot(maximize_templateObject9 || (maximize_templateObject9 = maximize_taggedTemplateLiteral(["familiar"]))));
    if (familiarEquip) (0,external_kolmafia_namespaceObject.equip)(template_string_$slot(maximize_templateObject10 || (maximize_templateObject10 = maximize_taggedTemplateLiteral(["familiar"]))), familiarEquip);
  } else {
...
function saveCached(cacheKey, options) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)(template_string_$item(maximize_templateObject34 || (maximize_templateObject34 = maximize_taggedTemplateLiteral(["card sleeve"])))) > 0) {
    equipment.set(template_string_$slot(_templateObject35 || (_templateObject35 = maximize_taggedTemplateLiteral(["card-sleeve"]))), (0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(_templateObject36 || (_templateObject36 = maximize_taggedTemplateLiteral(["card-sleeve"])))));
  }
  ...
  if (options.preventSlot && options.preventSlot.length > 0) {
    ...
    if (options.preventSlot.includes(template_string_$slot(_templateObject41 || (_templateObject41 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete(template_string_$item(_templateObject42 || (_templateObject42 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }

    if (options.preventSlot.includes(template_string_$slot(_templateObject43 || (_templateObject43 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
  ...
  if (options.onlySlot && options.onlySlot.length > 0) {
    ...
    if (!options.onlySlot.includes(template_string_$slot(_templateObject45 || (_templateObject45 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete(template_string_$item(_templateObject46 || (_templateObject46 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }

    if (!options.onlySlot.includes(template_string_$slot(_templateObject47 || (_templateObject47 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
...
var moxieOutfit = new OutfitPlan({
  ...
  acc3: template_string_$item(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["Retrospecs"]))),
  familiar: template_string_$item(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var hpOutfit = new OutfitPlan({
  hat: template_string_$items(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["extra-wide head candle, wad of used tape"]))),
  weapon: template_string_$item(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
