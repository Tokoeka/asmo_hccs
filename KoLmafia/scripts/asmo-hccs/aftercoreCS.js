...
var substringCombatSkills = template_string_$skills(combat_templateObject2 || (combat_templateObject2 = combat_taggedTemplateLiteral(["Shoot, Thrust-Smack, Headbutt, Toss, Sing, Disarm, LIGHT, BURN, Extract, Meteor Shower, Cleave, Boil, Slice, Rainbow"])));
...
var Driving = {
  Obnoxiously: template_string_$effect(AsdonMartin_templateObject6 || (AsdonMartin_templateObject6 = AsdonMartin_taggedTemplateLiteral(["Driving Obnoxiously"]))),
  Stealthily: template_string_$effect(AsdonMartin_templateObject7 || (AsdonMartin_templateObject7 = AsdonMartin_taggedTemplateLiteral(["Driving Stealthily"]))),
  Wastefully: template_string_$effect(AsdonMartin_templateObject8 || (AsdonMartin_templateObject8 = AsdonMartin_taggedTemplateLiteral(["Driving Wastefully"]))),
  ...
  Waterproofly: template_string_$effect(AsdonMartin_templateObject14 || (AsdonMartin_templateObject14 = AsdonMartin_taggedTemplateLiteral(["Driving Waterproofly"])))
};
/**
...
function saveCached(cacheKey, options) {
  ...
  if ((0,external_kolmafia_namespaceObject.equippedAmount)(template_string_$item(maximize_templateObject28 || (maximize_templateObject28 = maximize_taggedTemplateLiteral(["card sleeve"])))) > 0) {
    equipment.set(template_string_$slot(maximize_templateObject29 || (maximize_templateObject29 = maximize_taggedTemplateLiteral(["card-sleeve"]))), (0,external_kolmafia_namespaceObject.equippedItem)(template_string_$slot(maximize_templateObject30 || (maximize_templateObject30 = maximize_taggedTemplateLiteral(["card-sleeve"])))));
  }
  ...
  if (options.preventSlot && options.preventSlot.length > 0) {
    ...
    if (options.preventSlot.includes(template_string_$slot(_templateObject35 || (_templateObject35 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete(template_string_$item(_templateObject36 || (_templateObject36 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }

    if (options.preventSlot.includes(template_string_$slot(_templateObject37 || (_templateObject37 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
  ...
  if (options.onlySlot && options.onlySlot.length > 0) {
    ...
    if (!options.onlySlot.includes(template_string_$slot(_templateObject39 || (_templateObject39 = maximize_taggedTemplateLiteral(["buddy-bjorn"]))))) {
      rider.delete(template_string_$item(_templateObject40 || (_templateObject40 = maximize_taggedTemplateLiteral(["Buddy Bjorn"]))));
    }

    if (!options.onlySlot.includes(template_string_$slot(_templateObject41 || (_templateObject41 = maximize_taggedTemplateLiteral(["crown-of-thrones"]))))) {
...
var modeables = {
  backupcamera: template_string_$item(outfit_templateObject || (outfit_templateObject = outfit_taggedTemplateLiteral(["backup camera"]))),
  umbrella: template_string_$item(outfit_templateObject2 || (outfit_templateObject2 = outfit_taggedTemplateLiteral(["unbreakable umbrella"]))),
  snowsuit: template_string_$item(outfit_templateObject3 || (outfit_templateObject3 = outfit_taggedTemplateLiteral(["Snow Suit"]))),
  edpiece: template_string_$item(outfit_templateObject4 || (outfit_templateObject4 = outfit_taggedTemplateLiteral(["The Crown of Ed the Undying"]))),
  retrocape: template_string_$item(outfit_templateObject5 || (outfit_templateObject5 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  parka: template_string_$item(outfit_templateObject6 || (outfit_templateObject6 = outfit_taggedTemplateLiteral(["Jurassic Parka"])))
};
var outfitSlots = ["weapon", "offhand", "hat", "back", "shirt", "pants", "acc1", "acc2", "acc3", "familiar"];
var outfit_Outfit = /*#__PURE__*/function () {
  /**
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function dress() {
      ...
      var accessorySlots = $slots(outfit_templateObject7 || (outfit_templateObject7 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"])));
      ...
      var _iterator = outfit_createForOfIteratorHelper($slots(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var slot = _step.value;
          if (targetEquipment.includes((0,external_kolmafia_namespaceObject.equippedItem)(slot)) && equipmentMap.get(slot) !== (0,external_kolmafia_namespaceObject.equippedItem)(slot)) (0,external_kolmafia_namespaceObject.equip)(slot, template_string_$item(outfit_templateObject9 || (outfit_templateObject9 = outfit_taggedTemplateLiteral(["none"]))));
      ...
      var _iterator2 = outfit_createForOfIteratorHelper($slots(outfit_templateObject10 || (outfit_templateObject10 = outfit_taggedTemplateLiteral(["weapon, offhand, hat, back, shirt, pants, familiar"])))),
          _step2;
      ...
      try {
        var _loop = function _loop() {
          ...
          if (currentEquip === template_string_$item(outfit_templateObject11 || (outfit_templateObject11 = outfit_taggedTemplateLiteral(["none"]))) || (0,external_kolmafia_namespaceObject.equippedAmount)(currentEquip) > accessoryEquips.filter(accessory => accessory === currentEquip).length) {
    ...
    value: function _with(callback) {
      return outfit_withOutfit(this, callback);
    }
    /**
    ...
    value: function current() {
      ...
      var _iterator4 = outfit_createForOfIteratorHelper(outfitSlots),
          _step4;
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          if (item !== template_string_$item(outfit_templateObject12 || (outfit_templateObject12 = outfit_taggedTemplateLiteral(["none"])))) fit[slotName] = item;
        }
      } catch (err) {
        _iterator4.e(err);
      } finally {
...
var OutfitPlan = /*#__PURE__*/function () {
  function OutfitPlan(outline) {
    ...
    outfit_classCallCheck(this, OutfitPlan);
  ...
  outfit_createClass(OutfitPlan, [{
    ...
    value: function build() {
      ...
      var _iterator5 = outfit_createForOfIteratorHelper(outfitSlots),
          _step5;
      ...
      return new outfit_Outfit(fit, this.familiar, this.modes);
    }
  }, {
    key: "dress",
    ...
    value: function merge(other) {
      if (other instanceof OutfitPlan) {
        ...
        var _iterator6 = outfit_createForOfIteratorHelper(outfitSlots),
            _step6;
...
function outfit_withOutfit(outfit, callback) {
  var withFamiliar = outfit.familiar !== undefined;
  var cachedOutfit = outfit_Outfit.current(withFamiliar);
  outfit.dress();
...
function uniform() {
  var defaultUniform = {
    hat: inMoxClass() ? $items(outfit_templateObject14 || (outfit_templateObject14 = outfit_taggedTemplateLiteral(["very pointy crown, Iunion Crown"]))) : inMysClass() ? $items(outfit_templateObject15 || (outfit_templateObject15 = outfit_taggedTemplateLiteral(["astral chapeau, Iunion Crown"]))) : $items(outfit_templateObject16 || (outfit_templateObject16 = outfit_taggedTemplateLiteral(["Daylight Shavings Helmet, Iunion Crown"]))),
    shirt: $items(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["LOV Eardigan, Jurassic Parka, fresh coat of paint"]))),
    pants: get("sweat", 0) < 100 ? $item(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["designer sweatpants"]))) : $items(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts, old sweatpants"]))),
    weapon: get("_juneCleaverFightsLeft") > 0 && get("_juneCleaverEncounters") < 2 ? $item(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["June cleaver"]))) : $item(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
    offhand: $items(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["unbreakable umbrella, familiar scrapbook"]))),
    acc1: $items(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["meteorite necklace, hewn moon-rune spoon"]))),
    acc2: $item(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["Beach Comb"]))),
    acc3: $items(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["battle broom, LOV Earrings, Powerful Glove"]))),
    back: $items(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["LOV Epaulettes, unwrapped knock-off retro superhero cape, vampyric cloake"])))
  };
...
var wireOutfit = new OutfitPlan({
  hat: template_string_$item(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["Iunion Crown"]))),
  shirt: template_string_$item(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["fresh coat of paint"]))),
  pants: template_string_$item(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  weapon: template_string_$item(outfit_templateObject30 || (outfit_templateObject30 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["Abracandalabra, familiar scrapbook"]))),
  acc1: template_string_$item(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["Eight Days a Week Pill Keeper"]))),
  acc2: template_string_$item(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["Powerful Glove"]))),
  acc3: template_string_$item(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["Guzzlr tablet"])))
});
var moxieOutfit = new OutfitPlan({
  hat: template_string_$item(outfit_templateObject35 || (outfit_templateObject35 = outfit_taggedTemplateLiteral(["very pointy crown"]))),
  shirt: template_string_$items(outfit_templateObject36 || (outfit_templateObject36 = outfit_taggedTemplateLiteral(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(outfit_templateObject37 || (outfit_templateObject37 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$items(outfit_templateObject38 || (outfit_templateObject38 = outfit_taggedTemplateLiteral(["Staff of Kitchen Royalty, Fourth of May Cosplay Saber"]))),
  offhand: template_string_$item(outfit_templateObject39 || (outfit_templateObject39 = outfit_taggedTemplateLiteral(["unbreakable umbrella"]))),
  pants: template_string_$item(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["Beach Comb"]))),
  acc2: template_string_$items(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["your cowboy boots, \"I Voted!\" sticker"]))),
  acc3: template_string_$item(_templateObject43 || (_templateObject43 = outfit_taggedTemplateLiteral(["Retrospecs"]))),
  familiar: template_string_$item(_templateObject44 || (_templateObject44 = outfit_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var hpOutfit = new OutfitPlan({
  hat: template_string_$items(_templateObject45 || (_templateObject45 = outfit_taggedTemplateLiteral(["extra-wide head candle, wad of used tape"]))),
  weapon: template_string_$item(_templateObject46 || (_templateObject46 = outfit_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(_templateObject47 || (_templateObject47 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  shirt: template_string_$items(_templateObject48 || (_templateObject48 = outfit_taggedTemplateLiteral(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$items(_templateObject49 || (_templateObject49 = outfit_taggedTemplateLiteral(["vampyric cloake, unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(_templateObject50 || (_templateObject50 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(_templateObject51 || (_templateObject51 = outfit_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(_templateObject52 || (_templateObject52 = outfit_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(_templateObject53 || (_templateObject53 = outfit_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(_templateObject54 || (_templateObject54 = outfit_taggedTemplateLiteral(["miniature crystal ball"])))
}, {
  modes: {
...
var muscleOutfit = new OutfitPlan({
  hat: template_string_$item(_templateObject55 || (_templateObject55 = outfit_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$item(_templateObject56 || (_templateObject56 = outfit_taggedTemplateLiteral(["dented scepter"]))),
  offhand: template_string_$item(_templateObject57 || (_templateObject57 = outfit_taggedTemplateLiteral(["unbreakable umbrella"]))),
  shirt: template_string_$items(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["Jurassic Parka, shoe ad T-shirt, fresh coat of paint"]))),
  back: template_string_$item(_templateObject59 || (_templateObject59 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  pants: template_string_$item(_templateObject60 || (_templateObject60 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts"]))),
  acc1: template_string_$item(_templateObject61 || (_templateObject61 = outfit_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(_templateObject62 || (_templateObject62 = outfit_taggedTemplateLiteral(["Retrospecs"]))),
  acc3: template_string_$item(_templateObject63 || (_templateObject63 = outfit_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$item(_templateObject64 || (_templateObject64 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))
}, {
  familiar: template_string_$familiar(_templateObject65 || (_templateObject65 = outfit_taggedTemplateLiteral(["Disembodied Hand"]))),
  modes: {
    retrocape: ["vampire", currentMode()]
  }
});
var mysticalityOutfit = new OutfitPlan({
  hat: template_string_$items(_templateObject66 || (_templateObject66 = outfit_taggedTemplateLiteral(["astral chapeau, wad of used tape"]))),
  weapon: template_string_$item(_templateObject67 || (_templateObject67 = outfit_taggedTemplateLiteral(["weeping willow wand"]))),
  offhand: template_string_$item(_templateObject68 || (_templateObject68 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  back: template_string_$item(_templateObject69 || (_templateObject69 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  shirt: template_string_$items(_templateObject70 || (_templateObject70 = outfit_taggedTemplateLiteral(["Jurassic Parka, denim jacket, shoe ad T-shirt, fresh coat of paint"]))),
  pants: template_string_$item(_templateObject71 || (_templateObject71 = outfit_taggedTemplateLiteral(["designer sweatpants"]))),
  acc1: template_string_$item(_templateObject72 || (_templateObject72 = outfit_taggedTemplateLiteral(["Retrospecs"]))),
  //acc2: $item`codpiece`,
  acc3: template_string_$item(_templateObject73 || (_templateObject73 = outfit_taggedTemplateLiteral(["battle broom"]))),
  familiar: template_string_$item(_templateObject74 || (_templateObject74 = outfit_taggedTemplateLiteral(["Abracandalabra"])))
}, {
  familiar: template_string_$familiar(_templateObject75 || (_templateObject75 = outfit_taggedTemplateLiteral(["Left-Hand Man"]))),
  modes: {
    retrocape: ["heck", currentMode()]
  }
});
var itemOutfit = new OutfitPlan({
  hat: template_string_$item(_templateObject76 || (_templateObject76 = outfit_taggedTemplateLiteral(["wad of used tape"]))),
  weapon: template_string_$items(_templateObject77 || (_templateObject77 = outfit_taggedTemplateLiteral(["extra-large utility candle"]))),
  offhand: template_string_$items(_templateObject78 || (_templateObject78 = outfit_taggedTemplateLiteral(["unbreakable umbrella, cursed magnifying glass"]))),
  back: template_string_$item(_templateObject79 || (_templateObject79 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))),
  acc1: template_string_$item(_templateObject80 || (_templateObject80 = outfit_taggedTemplateLiteral(["Guzzlr tablet"]))),
  acc2: template_string_$item(_templateObject81 || (_templateObject81 = outfit_taggedTemplateLiteral(["gold detective badge"]))),
  acc3: template_string_$items(_templateObject82 || (_templateObject82 = outfit_taggedTemplateLiteral(["your cowboy boots, government-issued night-vision goggles"]))),
  familiar: template_string_$item(_templateObject83 || (_templateObject83 = outfit_taggedTemplateLiteral(["li'l ninja costume"])))
}, {
  familiar: template_string_$familiar(_templateObject84 || (_templateObject84 = outfit_taggedTemplateLiteral(["Trick-or-Treating Tot"]))),
  modes: {
    umbrella: "bucket"
  }
});
var hotresOutfit = new OutfitPlan({
  back: template_string_$item(_templateObject85 || (_templateObject85 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
  weapon: template_string_$items(_templateObject86 || (_templateObject86 = outfit_taggedTemplateLiteral(["industrial fire extinguisher, Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(_templateObject87 || (_templateObject87 = outfit_taggedTemplateLiteral(["meteorite guard, latte lovers member's mug"]))),
  shirt: template_string_$item(_templateObject88 || (_templateObject88 = outfit_taggedTemplateLiteral(["Jurassic Parka"]))),
  pants: template_string_$item(_templateObject89 || (_templateObject89 = outfit_taggedTemplateLiteral(["designer sweatpants"]))),
  //acc1: $item`your cowboy boots`,
  acc2: template_string_$item(_templateObject90 || (_templateObject90 = outfit_taggedTemplateLiteral(["Brutal brogues"]))),
  acc3: template_string_$item(_templateObject91 || (_templateObject91 = outfit_taggedTemplateLiteral(["Beach Comb"])))
}, {
  familiar: template_string_$familiar(_templateObject92 || (_templateObject92 = outfit_taggedTemplateLiteral(["Exotic Parrot"]))),
  modes: {
...
var noncombatOutfit = new OutfitPlan({
  hat: template_string_$item(_templateObject93 || (_templateObject93 = outfit_taggedTemplateLiteral(["very pointy crown"]))),
  back: template_string_$item(_templateObject94 || (_templateObject94 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))),
  weapon: template_string_$item(_templateObject95 || (_templateObject95 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(_templateObject96 || (_templateObject96 = outfit_taggedTemplateLiteral(["unbreakable umbrella, rope, burning paper crane, familiar scrapbook"]))),
  shirt: template_string_$item(_templateObject97 || (_templateObject97 = outfit_taggedTemplateLiteral(["Jurassic Parka"]))),
  pants: template_string_$items(_templateObject98 || (_templateObject98 = outfit_taggedTemplateLiteral(["repaid diaper, Great Wolf's beastly trousers, designer sweatpants"]))),
  acc1: template_string_$item(_templateObject99 || (_templateObject99 = outfit_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
  acc2: template_string_$items(_templateObject100 || (_templateObject100 = outfit_taggedTemplateLiteral(["atlas of local maps, Kremlin's Greatest Briefcase"]))),
  acc3: template_string_$item(_templateObject101 || (_templateObject101 = outfit_taggedTemplateLiteral(["Brutal brogues"])))
}, {
  familiar: template_string_$familiar(_templateObject102 || (_templateObject102 = outfit_taggedTemplateLiteral(["Disgeist"]))),
  modes: {
    umbrella: "cocoon",
    parka: "pterodactyl"
  }
});
var familiarAndEquip = lib_have(template_string_$familiar(_templateObject103 || (_templateObject103 = outfit_taggedTemplateLiteral(["Doppelshifter"])))) && !(0,external_kolmafia_namespaceObject.inHardcore)() ? {
  fam: template_string_$familiar(_templateObject104 || (_templateObject104 = outfit_taggedTemplateLiteral(["Doppelshifter"]))),
  equip: template_string_$item(_templateObject105 || (_templateObject105 = outfit_taggedTemplateLiteral(["tiny costume wardrobe"])))
} : lib_have(template_string_$item(_templateObject106 || (_templateObject106 = outfit_taggedTemplateLiteral(["Snow Suit"])))) && !(0,external_kolmafia_namespaceObject.inHardcore)() ? {
  fam: template_string_$familiar(_templateObject107 || (_templateObject107 = outfit_taggedTemplateLiteral(["Exotic Parrot"]))),
  equip: template_string_$item(_templateObject108 || (_templateObject108 = outfit_taggedTemplateLiteral(["Snow Suit"])))
} : lib_have(template_string_$item(_templateObject109 || (_templateObject109 = outfit_taggedTemplateLiteral(["cracker"])))) ? {
  fam: template_string_$familiar(_templateObject110 || (_templateObject110 = outfit_taggedTemplateLiteral(["Exotic Parrot"]))),
  equip: template_string_$item(_templateObject111 || (_templateObject111 = outfit_taggedTemplateLiteral(["cracker"])))
} : lib_have(template_string_$familiar(_templateObject112 || (_templateObject112 = outfit_taggedTemplateLiteral(["Baby Bugged Bugbear"])))) ? {
  fam: template_string_$familiar(_templateObject113 || (_templateObject113 = outfit_taggedTemplateLiteral(["Baby Bugged Bugbear"]))),
  equip: template_string_$item(_templateObject114 || (_templateObject114 = outfit_taggedTemplateLiteral(["bugged beanie"])))
} : {
  fam: template_string_$familiar(_templateObject115 || (_templateObject115 = outfit_taggedTemplateLiteral(["Blood-Faced Volleyball"]))),
  equip: lib_have(template_string_$item(_templateObject116 || (_templateObject116 = outfit_taggedTemplateLiteral(["astral pet sweater"])))) ? template_string_$item(_templateObject117 || (_templateObject117 = outfit_taggedTemplateLiteral(["astral pet sweater"]))) : template_string_$item(_templateObject118 || (_templateObject118 = outfit_taggedTemplateLiteral(["none"])))
};
var famweightOutfit = new OutfitPlan({
  hat: template_string_$item(_templateObject119 || (_templateObject119 = outfit_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
  weapon: template_string_$item(_templateObject120 || (_templateObject120 = outfit_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
  offhand: template_string_$items(_templateObject121 || (_templateObject121 = outfit_taggedTemplateLiteral(["rope, burning paper crane, familiar scrapbook"]))),
  pants: template_string_$items(_templateObject122 || (_templateObject122 = outfit_taggedTemplateLiteral(["repaid diaper, Great Wolf's beastly trousers, designer sweatpants"]))),
  acc1: template_string_$item(_templateObject123 || (_templateObject123 = outfit_taggedTemplateLiteral(["Beach Comb"]))),
  acc2: template_string_$item(_templateObject124 || (_templateObject124 = outfit_taggedTemplateLiteral(["Brutal brogues"]))),
  acc3: template_string_$item(_templateObject125 || (_templateObject125 = outfit_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
  familiar: familiarAndEquip.equip
}, {
  familiar: familiarAndEquip.fam
});
var weaponOutfit = new OutfitPlan({
  hat: template_string_$items(_templateObject126 || (_templateObject126 = outfit_taggedTemplateLiteral(["seal-skull helmet"]))),
  weapon: template_string_$item(_templateObject127 || (_templateObject127 = outfit_taggedTemplateLiteral(["broken champagne bottle"]))),
  offhand: template_string_$item(_templateObject128 || (_templateObject128 = outfit_taggedTemplateLiteral(["dented scepter"]))),
  pants: template_string_$item(_templateObject129 || (_templateObject129 = outfit_taggedTemplateLiteral(["Great Wolf's beastly trousers"]))),
  acc1: template_string_$item(_templateObject130 || (_templateObject130 = outfit_taggedTemplateLiteral(["Brutal brogues"]))),
  acc2: template_string_$item(_templateObject131 || (_templateObject131 = outfit_taggedTemplateLiteral(["Powerful Glove"]))),
  acc3: template_string_$items(_templateObject132 || (_templateObject132 = outfit_taggedTemplateLiteral(["meteorite ring, Kremlin's Greatest Briefcase"]))),
  familiar: template_string_$items(_templateObject133 || (_templateObject133 = outfit_taggedTemplateLiteral(["Stick-Knife of Loathing"])))
}, {
  familiar: template_string_$familiar(_templateObject134 || (_templateObject134 = outfit_taggedTemplateLiteral(["Disembodied Hand"])))
});
var spellOutfit = new OutfitPlan({
  hat: template_string_$items(_templateObject135 || (_templateObject135 = outfit_taggedTemplateLiteral(["sugar chapeau, astral chapeau, Hollandaise helmet"]))),
  weapon: !(0,external_kolmafia_namespaceObject.inHardcore)() ? template_string_$item(_templateObject136 || (_templateObject136 = outfit_taggedTemplateLiteral(["Staff of Kitchen Royalty"]))) : template_string_$item(_templateObject137 || (_templateObject137 = outfit_taggedTemplateLiteral(["weeping willow wand"]))),
  offhand: [template_string_$item(_templateObject138 || (_templateObject138 = outfit_taggedTemplateLiteral(["Abracandalabra"])))].concat(outfit_toConsumableArray((0,external_kolmafia_namespaceObject.inHardcore)() ? template_string_$items(_templateObject139 || (_templateObject139 = outfit_taggedTemplateLiteral(["weeping willow wand, astral statuette"]))) : template_string_$items(_templateObject140 || (_templateObject140 = outfit_taggedTemplateLiteral(["obsidian nutcracker"]))))),
  pants: template_string_$items(_templateObject141 || (_templateObject141 = outfit_taggedTemplateLiteral(["Pantaloons of Hatred, designer sweatpants"]))),
  acc1: template_string_$items(_templateObject142 || (_templateObject142 = outfit_taggedTemplateLiteral(["meteorite necklace, Kremlin's Greatest Briefcase"]))),
  acc2: template_string_$item(_templateObject143 || (_templateObject143 = outfit_taggedTemplateLiteral(["Powerful Glove"]))),
  acc3: template_string_$item(_templateObject144 || (_templateObject144 = outfit_taggedTemplateLiteral(["battle broom"]))),
  familiar: template_string_$items(_templateObject145 || (_templateObject145 = outfit_taggedTemplateLiteral(["Stick-Knife of Loathing, wrench"])))
}, {
  familiar: template_string_$familiar(_templateObject146 || (_templateObject146 = outfit_taggedTemplateLiteral(["Disembodied Hand"])))
});
;// CONCATENATED MODULE: ./src/asmohccs-lib.ts
var asmohccs_lib_templateObject, asmohccs_lib_templateObject2, asmohccs_lib_templateObject3, asmohccs_lib_templateObject4, asmohccs_lib_templateObject5, asmohccs_lib_templateObject6, asmohccs_lib_templateObject7, asmohccs_lib_templateObject8, asmohccs_lib_templateObject9, asmohccs_lib_templateObject10, asmohccs_lib_templateObject11, asmohccs_lib_templateObject12, asmohccs_lib_templateObject13, asmohccs_lib_templateObject14, asmohccs_lib_templateObject15, asmohccs_lib_templateObject16, asmohccs_lib_templateObject17, asmohccs_lib_templateObject18, asmohccs_lib_templateObject19, asmohccs_lib_templateObject20, asmohccs_lib_templateObject21, asmohccs_lib_templateObject22, asmohccs_lib_templateObject23, asmohccs_lib_templateObject24, asmohccs_lib_templateObject25, asmohccs_lib_templateObject26, asmohccs_lib_templateObject27, asmohccs_lib_templateObject28, asmohccs_lib_templateObject29, asmohccs_lib_templateObject30, asmohccs_lib_templateObject31, asmohccs_lib_templateObject32, asmohccs_lib_templateObject33, asmohccs_lib_templateObject34, asmohccs_lib_templateObject35, asmohccs_lib_templateObject36, asmohccs_lib_templateObject37, asmohccs_lib_templateObject38, _ref, asmohccs_lib_templateObject39, asmohccs_lib_templateObject40, asmohccs_lib_templateObject41, asmohccs_lib_templateObject42, asmohccs_lib_templateObject43, asmohccs_lib_templateObject44, asmohccs_lib_templateObject45, asmohccs_lib_templateObject46, asmohccs_lib_templateObject47, asmohccs_lib_templateObject48, asmohccs_lib_templateObject49, asmohccs_lib_templateObject50, asmohccs_lib_templateObject51, asmohccs_lib_templateObject52, asmohccs_lib_templateObject53, asmohccs_lib_templateObject54, asmohccs_lib_templateObject55, asmohccs_lib_templateObject56, asmohccs_lib_templateObject57, asmohccs_lib_templateObject58, asmohccs_lib_templateObject59, asmohccs_lib_templateObject60, asmohccs_lib_templateObject61, asmohccs_lib_templateObject62, asmohccs_lib_templateObject63, asmohccs_lib_templateObject64, asmohccs_lib_templateObject65, asmohccs_lib_templateObject66;
...
function gingerCandy() {
  if (!get("_asmo_gingercity")) {
    ...
    equip($slot(asmohccs_lib_templateObject2 || (asmohccs_lib_templateObject2 = asmohccs_lib_taggedTemplateLiteral(["familiar"]))), $item(asmohccs_lib_templateObject3 || (asmohccs_lib_templateObject3 = asmohccs_lib_taggedTemplateLiteral(["tiny stillsuit"]))));
    set("choiceAdventure1215", 1);
    set("choiceAdventure1204", 1);
    advMacroAA($location(asmohccs_lib_templateObject4 || (asmohccs_lib_templateObject4 = asmohccs_lib_taggedTemplateLiteral(["Gingerbread Civic Center"]))), Macro.step("runaway"), 1);
    advMacroAA($location(asmohccs_lib_templateObject5 || (asmohccs_lib_templateObject5 = asmohccs_lib_taggedTemplateLiteral(["Gingerbread Train Station"]))), Macro.step("runaway"), 4);
...
function useDefaultFamiliar() {
  ...
  if (!get("_bagOfCandy") && canAttack) {
    useFamiliar($familiar(asmohccs_lib_templateObject6 || (asmohccs_lib_templateObject6 = asmohccs_lib_taggedTemplateLiteral(["Stocking Mimic"]))));
  } else if (!haveEffect($effect(asmohccs_lib_templateObject7 || (asmohccs_lib_templateObject7 = asmohccs_lib_taggedTemplateLiteral(["Spit Upon"])))) && !get("csServicesPerformed").split(",").includes("Reduce Gazelle Population")) {
    useFamiliar($familiar(asmohccs_lib_templateObject8 || (asmohccs_lib_templateObject8 = asmohccs_lib_taggedTemplateLiteral(["Melodramedary"]))));
    equip($slot(asmohccs_lib_templateObject9 || (asmohccs_lib_templateObject9 = asmohccs_lib_taggedTemplateLiteral(["familiar"]))), $item(asmohccs_lib_templateObject10 || (asmohccs_lib_templateObject10 = asmohccs_lib_taggedTemplateLiteral(["dromedary drinking helmet"]))));
  } else if (canAttack && !have($item(asmohccs_lib_templateObject11 || (asmohccs_lib_templateObject11 = asmohccs_lib_taggedTemplateLiteral(["short stack of pancakes"])))) && !have($effect(asmohccs_lib_templateObject12 || (asmohccs_lib_templateObject12 = asmohccs_lib_taggedTemplateLiteral(["Shortly Stacked"])))) && !get("csServicesPerformed").split(",").includes("Breed More Collies")) {
    useFamiliar($familiar(asmohccs_lib_templateObject13 || (asmohccs_lib_templateObject13 = asmohccs_lib_taggedTemplateLiteral(["Shorter-Order Cook"]))));
    equip($slot(asmohccs_lib_templateObject14 || (asmohccs_lib_templateObject14 = asmohccs_lib_taggedTemplateLiteral(["familiar"]))), $item(asmohccs_lib_templateObject15 || (asmohccs_lib_templateObject15 = asmohccs_lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  } else if (!have($item(asmohccs_lib_templateObject16 || (asmohccs_lib_templateObject16 = asmohccs_lib_taggedTemplateLiteral(["burning newspaper"])))) && !have($item(asmohccs_lib_templateObject17 || (asmohccs_lib_templateObject17 = asmohccs_lib_taggedTemplateLiteral(["burning paper crane"]))))) {
    useFamiliar($familiar(asmohccs_lib_templateObject18 || (asmohccs_lib_templateObject18 = asmohccs_lib_taggedTemplateLiteral(["Garbage Fire"]))));
    equip($slot(asmohccs_lib_templateObject19 || (asmohccs_lib_templateObject19 = asmohccs_lib_taggedTemplateLiteral(["familiar"]))), $item(asmohccs_lib_templateObject20 || (asmohccs_lib_templateObject20 = asmohccs_lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  } else {
    useFamiliar($familiar(asmohccs_lib_templateObject21 || (asmohccs_lib_templateObject21 = asmohccs_lib_taggedTemplateLiteral(["Puck Man"]))));
    equip($slot(asmohccs_lib_templateObject22 || (asmohccs_lib_templateObject22 = asmohccs_lib_taggedTemplateLiteral(["familiar"]))), $item(asmohccs_lib_templateObject23 || (asmohccs_lib_templateObject23 = asmohccs_lib_taggedTemplateLiteral(["tiny stillsuit"]))));
  }
}
var Test;
  ...
  if (!have($effect(asmohccs_lib_templateObject24 || (asmohccs_lib_templateObject24 = asmohccs_lib_taggedTemplateLiteral(["Inner Elf"]))))) {
    ...
    try {
      withOutfit(new Outfit({
        acc3: $item(asmohccs_lib_templateObject25 || (asmohccs_lib_templateObject25 = asmohccs_lib_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
        familiar: $item(asmohccs_lib_templateObject26 || (asmohccs_lib_templateObject26 = asmohccs_lib_taggedTemplateLiteral(["tiny stillsuit"])))
      }, $familiar(asmohccs_lib_templateObject27 || (asmohccs_lib_templateObject27 = asmohccs_lib_taggedTemplateLiteral(["Machine Elf"])))), () => {
        asmohccs_lib_ensureEffect($effect(asmohccs_lib_templateObject28 || (asmohccs_lib_templateObject28 = asmohccs_lib_taggedTemplateLiteral(["Blood Bubble"]))));
        setChoice(326, 1);
        if (get("_kgbTranquilizerDartUses") >= 3) ensureMp(50);
        advMacro($location(asmohccs_lib_templateObject29 || (asmohccs_lib_templateObject29 = asmohccs_lib_taggedTemplateLiteral(["The Slime Tube"]))), Macro.trySkill($skill(asmohccs_lib_templateObject30 || (asmohccs_lib_templateObject30 = asmohccs_lib_taggedTemplateLiteral(["KGB tranquilizer dart"])))).trySkill($skill(asmohccs_lib_templateObject31 || (asmohccs_lib_templateObject31 = asmohccs_lib_taggedTemplateLiteral(["Snokebomb"])))));
      });
    } finally {
      setClan(get("asmocs_mainClan", "Alliance From Heck"));
    }

    if (!have($effect(asmohccs_lib_templateObject32 || (asmohccs_lib_templateObject32 = asmohccs_lib_taggedTemplateLiteral(["Inner Elf"]))))) {
...
function fightSausageIfAble(location, macro) {
  if (kramcoCheck()) {
    equip($slot(asmohccs_lib_templateObject33 || (asmohccs_lib_templateObject33 = asmohccs_lib_taggedTemplateLiteral(["off-hand"]))), $item(asmohccs_lib_templateObject34 || (asmohccs_lib_templateObject34 = asmohccs_lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))); //useDefaultFamiliar();
...
var songSlots = [$effects(asmohccs_lib_templateObject35 || (asmohccs_lib_templateObject35 = asmohccs_lib_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effects(asmohccs_lib_templateObject36 || (asmohccs_lib_templateObject36 = asmohccs_lib_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effects(asmohccs_lib_templateObject37 || (asmohccs_lib_templateObject37 = asmohccs_lib_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, The Magical Mojomuscular Melody, The Moxious Madrigal, Ode to Booze, Jackasses' Symphony of Destruction"]))), $effects(asmohccs_lib_templateObject38 || (asmohccs_lib_templateObject38 = asmohccs_lib_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation, The Sonata of Sneakiness, Fat Leon's Phat Loot Lyric, Polka of Plenty"])))];
...
function mapMacro(location, monster, macro) {
  macro.setAutoAttack();
  useSkill($skill(asmohccs_lib_templateObject39 || (asmohccs_lib_templateObject39 = asmohccs_lib_taggedTemplateLiteral(["Map the Monsters"]))));
  if (!get("mappingMonsters")) throw "I am not actually mapping anything. Weird!";else {
    while (get("mappingMonsters") && !have($effect(asmohccs_lib_templateObject40 || (asmohccs_lib_templateObject40 = asmohccs_lib_taggedTemplateLiteral(["Meteor Showered"]))))) {
...
function ensureMp(mp) {
  ...
  while (have($item(asmohccs_lib_templateObject41 || (asmohccs_lib_templateObject41 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"])))) || have($item(asmohccs_lib_templateObject42 || (asmohccs_lib_templateObject42 = asmohccs_lib_taggedTemplateLiteral(["magical sausage casing"])))) && myMp() < mp && get("_sausagesEaten") < 23) {
    retrieveItem($item(asmohccs_lib_templateObject43 || (asmohccs_lib_templateObject43 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"]))));
    eat($item(asmohccs_lib_templateObject44 || (asmohccs_lib_templateObject44 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"]))));
  }

  while (have($item(asmohccs_lib_templateObject45 || (asmohccs_lib_templateObject45 = asmohccs_lib_taggedTemplateLiteral(["psychokinetic energy blob"])))) && myMp() < mp) {
    use($item(asmohccs_lib_templateObject46 || (asmohccs_lib_templateObject46 = asmohccs_lib_taggedTemplateLiteral(["psychokinetic energy blob"]))));
  }

  if (myMp() < mp) restoreMp(mp);
}
var maximizeFamiliar = lib_have(template_string_$familiar(asmohccs_lib_templateObject47 || (asmohccs_lib_templateObject47 = asmohccs_lib_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$familiar(asmohccs_lib_templateObject48 || (asmohccs_lib_templateObject48 = asmohccs_lib_taggedTemplateLiteral(["Disembodied Hand"]))) : template_string_$familiar(asmohccs_lib_templateObject49 || (asmohccs_lib_templateObject49 = asmohccs_lib_taggedTemplateLiteral(["Left-Hand Man"])));
...
function burnLibrams() {
  if (!$skills(asmohccs_lib_templateObject50 || (asmohccs_lib_templateObject50 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart, Summon Taffy, Summon Love Song"]))).some(skill => have(skill))) return;

  while (canCastLibrams()) {
    var testsDone = get("csServicesPerformed").split(",");

    if ((!testsDone.includes("Breed More Collies") && !have($item(asmohccs_lib_templateObject51 || (asmohccs_lib_templateObject51 = asmohccs_lib_taggedTemplateLiteral(["green candy heart"])))) || !testsDone.includes("Make Margaritas") && !have($item(asmohccs_lib_templateObject52 || (asmohccs_lib_templateObject52 = asmohccs_lib_taggedTemplateLiteral(["lavender candy heart"]))))) && have($skill(asmohccs_lib_templateObject53 || (asmohccs_lib_templateObject53 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart"]))))) {
      useSkill($skill(asmohccs_lib_templateObject54 || (asmohccs_lib_templateObject54 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart"]))));
    } else if (!testsDone.includes("Breed More Collies") && !have($item(asmohccs_lib_templateObject55 || (asmohccs_lib_templateObject55 = asmohccs_lib_taggedTemplateLiteral(["love song of icy revenge"]))), 4) && have($skill(asmohccs_lib_templateObject56 || (asmohccs_lib_templateObject56 = asmohccs_lib_taggedTemplateLiteral(["Summon Love Song"]))))) {
      useSkill($skill(asmohccs_lib_templateObject57 || (asmohccs_lib_templateObject57 = asmohccs_lib_taggedTemplateLiteral(["Summon Love Song"]))));
    }
    /*else if (have($skill`Summon BRICKOs`) && get("_brickoEyeSummons") < 3) {
      ...
      var summonSkill = $skills(asmohccs_lib_templateObject58 || (asmohccs_lib_templateObject58 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart, Summon Love Song"]))).find(skill => have(skill));
...
function asmohccs_lib_inMysClass() {
  if ($classes(asmohccs_lib_templateObject59 || (asmohccs_lib_templateObject59 = asmohccs_lib_taggedTemplateLiteral(["Sauceror, Pastamancer"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function asmohccs_lib_inMoxClass() {
  if ($classes(asmohccs_lib_templateObject60 || (asmohccs_lib_templateObject60 = asmohccs_lib_taggedTemplateLiteral(["Accordion Thief, Disco Bandit"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function asmohccs_lib_inMusClass() {
  if ($classes(asmohccs_lib_templateObject61 || (asmohccs_lib_templateObject61 = asmohccs_lib_taggedTemplateLiteral(["Seal Clubber, Turtle Tamer"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function unequip(item) {
  while ((0,external_kolmafia_namespaceObject.equippedAmount)(item) > 0) {
    ...
    if (!slot) return;
    (0,external_kolmafia_namespaceObject.equip)(slot, template_string_$item(asmohccs_lib_templateObject62 || (asmohccs_lib_templateObject62 = asmohccs_lib_taggedTemplateLiteral(["none"]))));
  }
}
var chefstaves = template_string_$items(asmohccs_lib_templateObject63 || (asmohccs_lib_templateObject63 = asmohccs_lib_taggedTemplateLiteral(["Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist, Staff of the Roaring Hearth"])));
function juneCleave() {
  if (get("_juneCleaverFightsLeft") > 0) return;
  withOutfit(new Outfit({
    weapon: $item(asmohccs_lib_templateObject64 || (asmohccs_lib_templateObject64 = asmohccs_lib_taggedTemplateLiteral(["June cleaver"])))
  }), () => {
    withProperty("recoveryScript", "", () => {
      adv1($location(asmohccs_lib_templateObject65 || (asmohccs_lib_templateObject65 = asmohccs_lib_taggedTemplateLiteral(["Noob Cave"]))), -1, "");
      if (get("lastEncounter") === "Poetic Justice") useSkill($skill(asmohccs_lib_templateObject66 || (asmohccs_lib_templateObject66 = asmohccs_lib_taggedTemplateLiteral(["Tongue of the Walrus"]))));
    });
  });
}
;// CONCATENATED MODULE: ./src/aftercore-cs.ts
var aftercore_cs_templateObject, aftercore_cs_templateObject2, aftercore_cs_templateObject3, aftercore_cs_templateObject4, aftercore_cs_templateObject5, aftercore_cs_templateObject6, aftercore_cs_templateObject7, aftercore_cs_templateObject8, aftercore_cs_templateObject9, aftercore_cs_templateObject10, aftercore_cs_templateObject11, aftercore_cs_templateObject12, aftercore_cs_templateObject13, aftercore_cs_templateObject14, aftercore_cs_templateObject15, aftercore_cs_templateObject16, aftercore_cs_templateObject17;
...
if (property_get("encountersUntilDMTChoice") === 0 && property_get("lastDMTDuplication") < (0,external_kolmafia_namespaceObject.myAscensions)()) {
  ...
  var dupeVals = Array.from(dupeItems.values()).map(dupe => {
    return {
      dupeIt: dupe,
      value: (0,external_kolmafia_namespaceObject.mallPrice)(dupe)
    };
  });
  ...
  if (closet) {
    (0,external_kolmafia_namespaceObject.putCloset)(best.dupeIt, 2);
  }
}
...
(0,external_kolmafia_namespaceObject.equip)(template_string_$slot(aftercore_cs_templateObject7 || (aftercore_cs_templateObject7 = aftercore_cs_taggedTemplateLiteral(["familiar"]))), template_string_$item(aftercore_cs_templateObject8 || (aftercore_cs_templateObject8 = aftercore_cs_taggedTemplateLiteral(["tiny stillsuit"]))));
...
if (property_get("lastEncounter") !== "Lava Dogs") {
  (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(aftercore_cs_templateObject9 || (aftercore_cs_templateObject9 = aftercore_cs_taggedTemplateLiteral(["heat-resistant sheet metal"]))), 20);
  ...
  (0,external_kolmafia_namespaceObject.equip)(template_string_$slot(aftercore_cs_templateObject10 || (aftercore_cs_templateObject10 = aftercore_cs_taggedTemplateLiteral(["pants"]))), template_string_$item(aftercore_cs_templateObject11 || (aftercore_cs_templateObject11 = aftercore_cs_taggedTemplateLiteral(["designer sweatpants"]))));
  advMacro(template_string_$location(aftercore_cs_templateObject12 || (aftercore_cs_templateObject12 = aftercore_cs_taggedTemplateLiteral(["The Bubblin' Caldera"]))), combat_Macro.skill(template_string_$skill(aftercore_cs_templateObject13 || (aftercore_cs_templateObject13 = aftercore_cs_taggedTemplateLiteral(["Curse of Weaksauce"])))).skill(template_string_$skill(aftercore_cs_templateObject14 || (aftercore_cs_templateObject14 = aftercore_cs_taggedTemplateLiteral(["Micrometeorite"])))).while_("!times 3", combat_Macro.skill(template_string_$skill(aftercore_cs_templateObject15 || (aftercore_cs_templateObject15 = aftercore_cs_taggedTemplateLiteral(["Saucestorm"]))))).skill(template_string_$skill(aftercore_cs_templateObject16 || (aftercore_cs_templateObject16 = aftercore_cs_taggedTemplateLiteral(["Shrap"])))), () => property_get("lastEncounter") !== "Lava Dogs" && (0,external_kolmafia_namespaceObject.myTurncount)() - calderaTurns < 7);
...
if (!installed()) {
  (0,external_kolmafia_namespaceObject.use)(template_string_$item(aftercore_cs_templateObject17 || (aftercore_cs_templateObject17 = aftercore_cs_taggedTemplateLiteral(["Asdon Martin keyfob"]))));
  fillTo(200);
}
