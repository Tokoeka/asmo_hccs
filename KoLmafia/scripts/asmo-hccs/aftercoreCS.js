...
function moxieOutfit() {
  cliExecute("retrocape robot");
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject46 || (_templateObject46 = outfits_taggedTemplateLiteral(["hat"]))), $item(_templateObject47 || (_templateObject47 = outfits_taggedTemplateLiteral(["very pointy crown"])))], [$slot(_templateObject48 || (_templateObject48 = outfits_taggedTemplateLiteral(["shirt"]))), $items(_templateObject49 || (_templateObject49 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"])))], [$slot(_templateObject50 || (_templateObject50 = outfits_taggedTemplateLiteral(["back"]))), $item(_templateObject51 || (_templateObject51 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [$slot(_templateObject52 || (_templateObject52 = outfits_taggedTemplateLiteral(["weapon"]))), $item(_templateObject53 || (_templateObject53 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject54 || (_templateObject54 = outfits_taggedTemplateLiteral(["pants"]))), $item(_templateObject55 || (_templateObject55 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [$slot(_templateObject56 || (_templateObject56 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject57 || (_templateObject57 = outfits_taggedTemplateLiteral(["Beach Comb"])))], [$slot(_templateObject58 || (_templateObject58 = outfits_taggedTemplateLiteral(["acc2"]))), $items(_templateObject59 || (_templateObject59 = outfits_taggedTemplateLiteral(["your cowboy boots, \"I Voted!\" sticker"])))], [$slot(_templateObject60 || (_templateObject60 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject61 || (_templateObject61 = outfits_taggedTemplateLiteral(["Retrospecs"])))]])).dress();
}
function hpOutfit() {
  cliExecute("retrocape vampire");
  if (!have($item(_templateObject62 || (_templateObject62 = outfits_taggedTemplateLiteral(["wad of used tape"]))))) cliExecute("fold wad of used tape");
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject63 || (_templateObject63 = outfits_taggedTemplateLiteral(["hat"]))), $items(_templateObject64 || (_templateObject64 = outfits_taggedTemplateLiteral(["extra-wide head candle, wad of used tape"])))], [$slot(_templateObject65 || (_templateObject65 = outfits_taggedTemplateLiteral(["weapon"]))), $item(_templateObject66 || (_templateObject66 = outfits_taggedTemplateLiteral(["dented scepter"])))], [$slot(_templateObject67 || (_templateObject67 = outfits_taggedTemplateLiteral(["off-hand"]))), $item(_templateObject68 || (_templateObject68 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject69 || (_templateObject69 = outfits_taggedTemplateLiteral(["shirt"]))), $items(_templateObject70 || (_templateObject70 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"])))], [$slot(_templateObject71 || (_templateObject71 = outfits_taggedTemplateLiteral(["back"]))), $items(_templateObject72 || (_templateObject72 = outfits_taggedTemplateLiteral(["vampyric cloake, unwrapped knock-off retro superhero cape"])))], [$slot(_templateObject73 || (_templateObject73 = outfits_taggedTemplateLiteral(["pants"]))), $item(_templateObject74 || (_templateObject74 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [$slot(_templateObject75 || (_templateObject75 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject76 || (_templateObject76 = outfits_taggedTemplateLiteral(["Powerful Glove"])))], [$slot(_templateObject77 || (_templateObject77 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject78 || (_templateObject78 = outfits_taggedTemplateLiteral(["Retrospecs"])))], [$slot(_templateObject79 || (_templateObject79 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject80 || (_templateObject80 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [$slot(_templateObject81 || (_templateObject81 = outfits_taggedTemplateLiteral(["familiar"]))), $item(_templateObject82 || (_templateObject82 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))]])).dress();
}
function muscleOutfit() {
  cliExecute("retrocape vampire");
  if (!have($item(_templateObject83 || (_templateObject83 = outfits_taggedTemplateLiteral(["wad of used tape"]))))) cliExecute("fold wad of used tape");
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject84 || (_templateObject84 = outfits_taggedTemplateLiteral(["hat"]))), $item(_templateObject85 || (_templateObject85 = outfits_taggedTemplateLiteral(["wad of used tape"])))], [$slot(_templateObject86 || (_templateObject86 = outfits_taggedTemplateLiteral(["weapon"]))), $item(_templateObject87 || (_templateObject87 = outfits_taggedTemplateLiteral(["dented scepter"])))], [$slot(_templateObject88 || (_templateObject88 = outfits_taggedTemplateLiteral(["off-hand"]))), have($familiar(_templateObject89 || (_templateObject89 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? $item(_templateObject90 || (_templateObject90 = outfits_taggedTemplateLiteral(["cosmetic football"]))) : $item(_templateObject91 || (_templateObject91 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject92 || (_templateObject92 = outfits_taggedTemplateLiteral(["shirt"]))), $items(_templateObject93 || (_templateObject93 = outfits_taggedTemplateLiteral(["shoe ad T-shirt, fresh coat of paint"])))], [$slot(_templateObject94 || (_templateObject94 = outfits_taggedTemplateLiteral(["back"]))), $item(_templateObject95 || (_templateObject95 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [$slot(_templateObject96 || (_templateObject96 = outfits_taggedTemplateLiteral(["pants"]))), $item(_templateObject97 || (_templateObject97 = outfits_taggedTemplateLiteral(["Cargo Cultist Shorts"])))], [$slot(_templateObject98 || (_templateObject98 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject99 || (_templateObject99 = outfits_taggedTemplateLiteral(["Brutal brogues"])))], [$slot(_templateObject100 || (_templateObject100 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject101 || (_templateObject101 = outfits_taggedTemplateLiteral(["Retrospecs"])))], [$slot(_templateObject102 || (_templateObject102 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject103 || (_templateObject103 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [$slot(_templateObject104 || (_templateObject104 = outfits_taggedTemplateLiteral(["familiar"]))), have($familiar(_templateObject105 || (_templateObject105 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? $item(_templateObject106 || (_templateObject106 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))) : $item(_templateObject107 || (_templateObject107 = outfits_taggedTemplateLiteral(["miniature crystal ball"])))]]), have($familiar(_templateObject108 || (_templateObject108 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))) ? $familiar(_templateObject109 || (_templateObject109 = outfits_taggedTemplateLiteral(["Disembodied Hand"]))) : undefined).dress();
}
function mysticalityOutfit() {
  cliExecute("retrocape heck");
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject110 || (_templateObject110 = outfits_taggedTemplateLiteral(["hat"]))), $items(_templateObject111 || (_templateObject111 = outfits_taggedTemplateLiteral(["astral chapeau, wad of used tape"])))], [$slot(_templateObject112 || (_templateObject112 = outfits_taggedTemplateLiteral(["weapon"]))), $items(_templateObject113 || (_templateObject113 = outfits_taggedTemplateLiteral(["weeping willow wand"])))], [$slot(_templateObject114 || (_templateObject114 = outfits_taggedTemplateLiteral(["off-hand"]))), $item(_templateObject115 || (_templateObject115 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject116 || (_templateObject116 = outfits_taggedTemplateLiteral(["back"]))), $item(_templateObject117 || (_templateObject117 = outfits_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))], [$slot(_templateObject118 || (_templateObject118 = outfits_taggedTemplateLiteral(["shirt"]))), $items(_templateObject119 || (_templateObject119 = outfits_taggedTemplateLiteral(["denim jacket, shoe ad T-shirt, fresh coat of paint"])))], [$slot(_templateObject120 || (_templateObject120 = outfits_taggedTemplateLiteral(["pants"]))), $items(_templateObject121 || (_templateObject121 = outfits_taggedTemplateLiteral(["cargo cultist shorts, pantogram pants"])))], [$slot(_templateObject122 || (_templateObject122 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject123 || (_templateObject123 = outfits_taggedTemplateLiteral(["retrospecs"])))], //TODO See if there is anything better
  [$slot(_templateObject124 || (_templateObject124 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject125 || (_templateObject125 = outfits_taggedTemplateLiteral(["codpiece"])))], [$slot(_templateObject126 || (_templateObject126 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject127 || (_templateObject127 = outfits_taggedTemplateLiteral(["battle broom"])))], [$slot(_templateObject128 || (_templateObject128 = outfits_taggedTemplateLiteral(["familiar"]))), $item(_templateObject129 || (_templateObject129 = outfits_taggedTemplateLiteral(["Abracandalabra"])))]]), $familiar(_templateObject130 || (_templateObject130 = outfits_taggedTemplateLiteral(["Left-Hand Man"])))).dress();
}
function itemOutfit() {
  ...
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject132 || (_templateObject132 = outfits_taggedTemplateLiteral(["hat"]))), $item(_templateObject133 || (_templateObject133 = outfits_taggedTemplateLiteral(["wad of used tape"])))], [$slot(_templateObject134 || (_templateObject134 = outfits_taggedTemplateLiteral(["weapon"]))), $items(_templateObject135 || (_templateObject135 = outfits_taggedTemplateLiteral(["extra-large utility candle, runed taper candle, novelty sparkling candle"])))], [$slot(_templateObject136 || (_templateObject136 = outfits_taggedTemplateLiteral(["off-hand"]))), $items(_templateObject137 || (_templateObject137 = outfits_taggedTemplateLiteral(["Cursed Magnifying Glass, Kramco Sausage-o-Matic\u2122"])))], //TODO Add Cursed Magnifying Glass once implemented in Mafia
  [$slot(_templateObject138 || (_templateObject138 = outfits_taggedTemplateLiteral(["back"]))), $items(_templateObject139 || (_templateObject139 = outfits_taggedTemplateLiteral(["vampyric cloake, protonic accelerator pack"])))], [$slot(_templateObject140 || (_templateObject140 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject141 || (_templateObject141 = outfits_taggedTemplateLiteral(["Guzzlr tablet"])))], [$slot(_templateObject142 || (_templateObject142 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject143 || (_templateObject143 = outfits_taggedTemplateLiteral(["gold detective badge"])))], [$slot(_templateObject144 || (_templateObject144 = outfits_taggedTemplateLiteral(["acc3"]))), $items(_templateObject145 || (_templateObject145 = outfits_taggedTemplateLiteral(["your cowboy boots, government-issued night-vision goggles"])))], [$slot(_templateObject146 || (_templateObject146 = outfits_taggedTemplateLiteral(["familiar"]))), $item(_templateObject147 || (_templateObject147 = outfits_taggedTemplateLiteral(["li'l ninja costume"])))]]), $familiar(_templateObject148 || (_templateObject148 = outfits_taggedTemplateLiteral(["Trick-or-Treating Tot"])))).dress();
}
...
function famweightOutfit() {
  var familiarAndEquip = !inHardcore() ? {
    fam: $familiar(_templateObject183 || (_templateObject183 = outfits_taggedTemplateLiteral(["Exotic Parrot"]))),
    equip: $item(_templateObject184 || (_templateObject184 = outfits_taggedTemplateLiteral(["snow suit"])))
  } : have($item(_templateObject185 || (_templateObject185 = outfits_taggedTemplateLiteral(["cracker"])))) ? {
    fam: $familiar(_templateObject186 || (_templateObject186 = outfits_taggedTemplateLiteral(["Exotic Parrot"]))),
    equip: $item(_templateObject187 || (_templateObject187 = outfits_taggedTemplateLiteral(["cracker"])))
  } : have($familiar(_templateObject188 || (_templateObject188 = outfits_taggedTemplateLiteral(["Baby Bugged Bugbear"])))) ? {
    fam: $familiar(_templateObject189 || (_templateObject189 = outfits_taggedTemplateLiteral(["Baby Bugged Bugbear"]))),
    equip: $item(_templateObject190 || (_templateObject190 = outfits_taggedTemplateLiteral(["bugged beanie"])))
  } : {
    fam: $familiar(_templateObject191 || (_templateObject191 = outfits_taggedTemplateLiteral(["Blood-Faced Volleyball"]))),
    equip: have($item(_templateObject192 || (_templateObject192 = outfits_taggedTemplateLiteral(["astral pet sweater"])))) ? $item(_templateObject193 || (_templateObject193 = outfits_taggedTemplateLiteral(["astral pet sweater"]))) : $item(_templateObject194 || (_templateObject194 = outfits_taggedTemplateLiteral(["none"])))
  };
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject195 || (_templateObject195 = outfits_taggedTemplateLiteral(["hat"]))), $item(_templateObject196 || (_templateObject196 = outfits_taggedTemplateLiteral(["Daylight Shavings Helmet"])))], [$slot(_templateObject197 || (_templateObject197 = outfits_taggedTemplateLiteral(["weapon"]))), $item(_templateObject198 || (_templateObject198 = outfits_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))], [$slot(_templateObject199 || (_templateObject199 = outfits_taggedTemplateLiteral(["off-hand"]))), $items(_templateObject200 || (_templateObject200 = outfits_taggedTemplateLiteral(["rope, burning paper crane, familiar scrapbook"])))], [$slot(_templateObject201 || (_templateObject201 = outfits_taggedTemplateLiteral(["pants"]))), $items(_templateObject202 || (_templateObject202 = outfits_taggedTemplateLiteral(["repaid diaper, Great Wolf's beastly trousers, pantogram pants, Cargo Cultist Shorts"])))], [$slot(_templateObject203 || (_templateObject203 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject204 || (_templateObject204 = outfits_taggedTemplateLiteral(["Beach Comb"])))], [$slot(_templateObject205 || (_templateObject205 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject206 || (_templateObject206 = outfits_taggedTemplateLiteral(["Brutal brogues"])))], [$slot(_templateObject207 || (_templateObject207 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject208 || (_templateObject208 = outfits_taggedTemplateLiteral(["hewn moon-rune spoon"])))], [$slot(_templateObject209 || (_templateObject209 = outfits_taggedTemplateLiteral(["familiar"]))), familiarAndEquip.equip]]), familiarAndEquip.fam).dress();
}
function weaponOutfit() {
  if (!have($item(_templateObject210 || (_templateObject210 = outfits_taggedTemplateLiteral(["broken champagne bottle"]))))) cliExecute("fold broken champagne bottle");
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject211 || (_templateObject211 = outfits_taggedTemplateLiteral(["hat"]))), $items(_templateObject212 || (_templateObject212 = outfits_taggedTemplateLiteral(["extra-wide head candle, seal-skull helmet"])))], [$slot(_templateObject213 || (_templateObject213 = outfits_taggedTemplateLiteral(["weapon"]))), $item(_templateObject214 || (_templateObject214 = outfits_taggedTemplateLiteral(["broken champagne bottle"])))], [$slot(_templateObject215 || (_templateObject215 = outfits_taggedTemplateLiteral(["off-hand"]))), $item(_templateObject216 || (_templateObject216 = outfits_taggedTemplateLiteral(["dented scepter"])))], [$slot(_templateObject217 || (_templateObject217 = outfits_taggedTemplateLiteral(["acc1"]))), $item(_templateObject218 || (_templateObject218 = outfits_taggedTemplateLiteral(["Brutal brogues"])))], [$slot(_templateObject219 || (_templateObject219 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject220 || (_templateObject220 = outfits_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))], [$slot(_templateObject221 || (_templateObject221 = outfits_taggedTemplateLiteral(["acc3"]))), $items(_templateObject222 || (_templateObject222 = outfits_taggedTemplateLiteral(["meteorite ring, Powerful Glove"])))], [$slot(_templateObject223 || (_templateObject223 = outfits_taggedTemplateLiteral(["familiar"]))), $items(_templateObject224 || (_templateObject224 = outfits_taggedTemplateLiteral(["stick-knife of loathing, fish hatchet, mutant arm"])))]]), //CHECK THIS
  $familiar(_templateObject225 || (_templateObject225 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))).dress();
}
function spellOutfit() {
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject226 || (_templateObject226 = outfits_taggedTemplateLiteral(["hat"]))), $items(_templateObject227 || (_templateObject227 = outfits_taggedTemplateLiteral(["sugar chapeau, astral chapeau, Hollandaise helmet"])))], [$slot(_templateObject228 || (_templateObject228 = outfits_taggedTemplateLiteral(["weapon"]))), $items(_templateObject229 || (_templateObject229 = outfits_taggedTemplateLiteral(["Staff of Kitchen Royalty, weeping willow wand"])))], [$slot(_templateObject230 || (_templateObject230 = outfits_taggedTemplateLiteral(["familiar"]))), $items(_templateObject231 || (_templateObject231 = outfits_taggedTemplateLiteral(["stick-knife of loathing, wrench"])))], [$slot(_templateObject232 || (_templateObject232 = outfits_taggedTemplateLiteral(["off-hand"]))), $item(_templateObject233 || (_templateObject233 = outfits_taggedTemplateLiteral(["abracandalabra"])))], //[$slot`pants`, $item`pantogram pants`],
...
function fightSausageIfAble(location, macro) {
  if (kramcoCheck()) {
    equip($slot(asmohccs_lib_templateObject151 || (asmohccs_lib_templateObject151 = asmohccs_lib_taggedTemplateLiteral(["off-hand"]))), $item(asmohccs_lib_templateObject152 || (asmohccs_lib_templateObject152 = asmohccs_lib_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
...
var songSlots = [$effects(asmohccs_lib_templateObject153 || (asmohccs_lib_templateObject153 = asmohccs_lib_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effects(asmohccs_lib_templateObject154 || (asmohccs_lib_templateObject154 = asmohccs_lib_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effects(asmohccs_lib_templateObject155 || (asmohccs_lib_templateObject155 = asmohccs_lib_taggedTemplateLiteral(["Power Ballad of the Arrowsmith, The Magical Mojomuscular Melody, The Moxious Madrigal, Ode to Booze, Jackasses' Symphony of Destruction"]))), $effects(asmohccs_lib_templateObject156 || (asmohccs_lib_templateObject156 = asmohccs_lib_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation, The Sonata of Sneakiness, Fat Leon's Phat Loot Lyric, Polka of Plenty"])))];
...
function mapMacro(location, monster, macro) {
  macro.setAutoAttack();
  useSkill($skill(asmohccs_lib_templateObject157 || (asmohccs_lib_templateObject157 = asmohccs_lib_taggedTemplateLiteral(["Map the Monsters"]))));
  if (!get("mappingMonsters")) throw "I am not actually mapping anything. Weird!";else {
    while (get("mappingMonsters") && !have($effect(asmohccs_lib_templateObject158 || (asmohccs_lib_templateObject158 = asmohccs_lib_taggedTemplateLiteral(["Meteor Showered"]))))) {
...
function ensureMp(mp) {
  ...
  while (have($item(asmohccs_lib_templateObject159 || (asmohccs_lib_templateObject159 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"])))) || have($item(asmohccs_lib_templateObject160 || (asmohccs_lib_templateObject160 = asmohccs_lib_taggedTemplateLiteral(["magical sausage casing"])))) && myMp() < mp && get("_sausagesEaten") < 23) {
    retrieveItem($item(asmohccs_lib_templateObject161 || (asmohccs_lib_templateObject161 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"]))));
    eat($item(asmohccs_lib_templateObject162 || (asmohccs_lib_templateObject162 = asmohccs_lib_taggedTemplateLiteral(["magical sausage"]))));
  }

  while (have($item(asmohccs_lib_templateObject163 || (asmohccs_lib_templateObject163 = asmohccs_lib_taggedTemplateLiteral(["psychokinetic energy blob"])))) && myMp() < mp) {
    use($item(asmohccs_lib_templateObject164 || (asmohccs_lib_templateObject164 = asmohccs_lib_taggedTemplateLiteral(["psychokinetic energy blob"]))));
  }

  if (myMp() < mp) restoreMp(mp);
}
var maximizeFamiliar = lib_have(template_string_$familiar(asmohccs_lib_templateObject165 || (asmohccs_lib_templateObject165 = asmohccs_lib_taggedTemplateLiteral(["Disembodied Hand"])))) ? template_string_$familiar(asmohccs_lib_templateObject166 || (asmohccs_lib_templateObject166 = asmohccs_lib_taggedTemplateLiteral(["Disembodied Hand"]))) : template_string_$familiar(asmohccs_lib_templateObject167 || (asmohccs_lib_templateObject167 = asmohccs_lib_taggedTemplateLiteral(["Left-Hand Man"]))); // Checks that you don't already have the tonic or effect and if your syringe has the right phylum and if so, makes the appropriate tonic.
...
function burnLibrams() {
  if (!$skills(asmohccs_lib_templateObject168 || (asmohccs_lib_templateObject168 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart, Summon Taffy, Summon Love Song"]))).some(skill => have(skill))) return;

  while (canCastLibrams()) {
    var testsDone = get("csServicesPerformed").split(",");

    if ((!testsDone.includes("Breed More Collies") && !have($item(asmohccs_lib_templateObject169 || (asmohccs_lib_templateObject169 = asmohccs_lib_taggedTemplateLiteral(["green candy heart"])))) || !testsDone.includes("Make Margaritas") && !have($item(asmohccs_lib_templateObject170 || (asmohccs_lib_templateObject170 = asmohccs_lib_taggedTemplateLiteral(["lavender candy heart"]))))) && have($skill(asmohccs_lib_templateObject171 || (asmohccs_lib_templateObject171 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart"]))))) {
      useSkill($skill(asmohccs_lib_templateObject172 || (asmohccs_lib_templateObject172 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart"]))));
    } else if (!testsDone.includes("Breed More Collies") && !have($item(asmohccs_lib_templateObject173 || (asmohccs_lib_templateObject173 = asmohccs_lib_taggedTemplateLiteral(["love song of icy revenge"]))), 4) && have($skill(asmohccs_lib_templateObject174 || (asmohccs_lib_templateObject174 = asmohccs_lib_taggedTemplateLiteral(["Summon Love Song"]))))) {
      useSkill($skill(asmohccs_lib_templateObject175 || (asmohccs_lib_templateObject175 = asmohccs_lib_taggedTemplateLiteral(["Summon Love Song"]))));
    }
    /*else if (have($skill`Summon BRICKOs`) && get("_brickoEyeSummons") < 3) {
      ...
      var summonSkill = $skills(asmohccs_lib_templateObject176 || (asmohccs_lib_templateObject176 = asmohccs_lib_taggedTemplateLiteral(["Summon Candy Heart, Summon Love Song"]))).find(skill => have(skill));
...
function modTraceList(modifier) {
  ...
  var _iterator4 = asmohccs_lib_createForOfIteratorHelper($slots(asmohccs_lib_templateObject180 || (asmohccs_lib_templateObject180 = asmohccs_lib_taggedTemplateLiteral([""])))),
      _step4;
  ...
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      ...
      if (numericModifier(it, modifier) != 0 && (haveEquipped(it) || haveEquipped($item(asmohccs_lib_templateObject181 || (asmohccs_lib_templateObject181 = asmohccs_lib_taggedTemplateLiteral(["your cowboy boots"])))) && $slots(asmohccs_lib_templateObject182 || (asmohccs_lib_templateObject182 = asmohccs_lib_taggedTemplateLiteral(["bootspur, bootskin"]))).includes(slot))) {
  ...
  var famMod = numericModifier(myFamiliar(), modifier, familiarWeight(myFamiliar()) + weightAdjustment(), $item(asmohccs_lib_templateObject177 || (asmohccs_lib_templateObject177 = asmohccs_lib_taggedTemplateLiteral(["none"]))));
  ...
  var _iterator5 = asmohccs_lib_createForOfIteratorHelper($skills(asmohccs_lib_templateObject183 || (asmohccs_lib_templateObject183 = asmohccs_lib_taggedTemplateLiteral([""])))),
      _step5;
  ...
  var squint = $effect(asmohccs_lib_templateObject178 || (asmohccs_lib_templateObject178 = asmohccs_lib_taggedTemplateLiteral(["Steely-Eyed Squint"])));
  var swagger = $effect(asmohccs_lib_templateObject179 || (asmohccs_lib_templateObject179 = asmohccs_lib_taggedTemplateLiteral(["Bow-Legged Swagger"])));
...
function asmohccs_lib_inMysClass() {
  if ($classes(asmohccs_lib_templateObject184 || (asmohccs_lib_templateObject184 = asmohccs_lib_taggedTemplateLiteral(["Sauceror, Pastamancer"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function asmohccs_lib_inMoxClass() {
  if ($classes(asmohccs_lib_templateObject185 || (asmohccs_lib_templateObject185 = asmohccs_lib_taggedTemplateLiteral(["Accordion Thief, Disco Bandit"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function asmohccs_lib_inMusClass() {
  if ($classes(asmohccs_lib_templateObject186 || (asmohccs_lib_templateObject186 = asmohccs_lib_taggedTemplateLiteral(["Seal Clubber, Turtle Tamer"]))).includes(myClass())) {
    return true;
  } else {
    return false;
  }
...
function unequip(item) {
  while ((0,external_kolmafia_namespaceObject.equippedAmount)(item) > 0) {
    ...
    if (!slot) return;
    (0,external_kolmafia_namespaceObject.equip)(slot, template_string_$item(asmohccs_lib_templateObject187 || (asmohccs_lib_templateObject187 = asmohccs_lib_taggedTemplateLiteral(["none"]))));
  }
}
var chefstaves = template_string_$items(asmohccs_lib_templateObject188 || (asmohccs_lib_templateObject188 = asmohccs_lib_taggedTemplateLiteral(["Staff of Kitchen Royalty, Staff of the Deepest Freeze, Staff of Frozen Lard, Staff of the Peppermint Twist, Staff of the Roaring Hearth"])));
