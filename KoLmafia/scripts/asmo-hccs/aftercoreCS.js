...
function mysticalityOutfit() {
  ...
  [$slot(_templateObject126 || (_templateObject126 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject127 || (_templateObject127 = outfits_taggedTemplateLiteral(["codpiece"])))], [$slot(_templateObject128 || (_templateObject128 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject129 || (_templateObject129 = outfits_taggedTemplateLiteral(["battle broom"])))], [$slot(_templateObject130 || (_templateObject130 = outfits_taggedTemplateLiteral(["familiar"]))), $item(_templateObject131 || (_templateObject131 = outfits_taggedTemplateLiteral(["Abracandalabra"])))]]), $familiar(_templateObject132 || (_templateObject132 = outfits_taggedTemplateLiteral(["Left-Hand Man"])))).dress();
}
function itemOutfit() {
  if (!have($item(_templateObject133 || (_templateObject133 = outfits_taggedTemplateLiteral(["wad of used tape"]))))) cliExecute("fold wad of used tape");
...
function spellOutfit() {
  outfits_Outfit.doYourBest(new Map([[$slot(_templateObject236 || (_templateObject236 = outfits_taggedTemplateLiteral(["hat"]))), $items(_templateObject237 || (_templateObject237 = outfits_taggedTemplateLiteral(["sugar chapeau, astral chapeau, Hollandaise helmet"])))], [$slot(_templateObject238 || (_templateObject238 = outfits_taggedTemplateLiteral(["weapon"]))), $items(_templateObject239 || (_templateObject239 = outfits_taggedTemplateLiteral(["Staff of Kitchen Royalty, weeping willow wand"])))], [$slot(_templateObject240 || (_templateObject240 = outfits_taggedTemplateLiteral(["off-hand"]))), $item(_templateObject241 || (_templateObject241 = outfits_taggedTemplateLiteral(["abracandalabra"])))], //[$slot`pants`, $item`pantogram pants`],
  [$slot(_templateObject242 || (_templateObject242 = outfits_taggedTemplateLiteral(["acc1"]))), $items(_templateObject243 || (_templateObject243 = outfits_taggedTemplateLiteral(["meteorite necklace, Kremlin's Greatest Briefcase"])))], [$slot(_templateObject244 || (_templateObject244 = outfits_taggedTemplateLiteral(["acc2"]))), $item(_templateObject245 || (_templateObject245 = outfits_taggedTemplateLiteral(["powerful glove"])))], [$slot(_templateObject246 || (_templateObject246 = outfits_taggedTemplateLiteral(["acc3"]))), $item(_templateObject247 || (_templateObject247 = outfits_taggedTemplateLiteral(["battle broom"])))], [$slot(_templateObject248 || (_templateObject248 = outfits_taggedTemplateLiteral(["familiar"]))), $items(_templateObject249 || (_templateObject249 = outfits_taggedTemplateLiteral(["stick-knife of loathing, wrench"])))]]), $familiar(_templateObject250 || (_templateObject250 = outfits_taggedTemplateLiteral(["Disembodied Hand"])))).dress();
}
